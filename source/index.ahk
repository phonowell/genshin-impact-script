...
global __ci_genshin__ := Func("genshin_71")
if (A_IsAdmin != true) {
...
class ClientX {
  ...
  isActive := Func("genshin_69").Bind(this)
  reset := Func("genshin_68").Bind(this)
  resetKey := Func("genshin_67").Bind(this)
  resetTimer := Func("genshin_66").Bind(this)
  setSize := Func("genshin_65").Bind(this)
  suspend := Func("genshin_64").Bind(this)
  setPriority := Func("genshin_63").Bind(this)
  vh := Func("genshin_62").Bind(this)
  vw := Func("genshin_61").Bind(this)
}
class ConfigX {
  data := {}
  source := "config.ini"
  ...
  read := Func("genshin_60").Bind(this)
}
class ConsoleX {
  lifetime := 5000
  list := []
  ...
  clean := Func("genshin_58").Bind(this)
  hide := Func("genshin_57").Bind(this)
  log := Func("genshin_56").Bind(this)
  render := Func("genshin_55").Bind(this)
}
class HudX {
...
class MemberX {
  ...
  map := {}
  name := ""
  checkCharacterByPosition := Func("genshin_50").Bind(this)
  getRange := Func("genshin_49").Bind(this)
  scan := Func("genshin_48").Bind(this)
...
genshin_48(this) {
  ...
  for __index_for__, n in [1, 2, 3, 4] {
    $.delay.Call((n - 1) * 500, Func("genshin_47").Bind(n, this))
  }
}
genshin_49(this, n) {
...
genshin_60(this, key, defaultValue := 1) {
...
genshin_63(this, level) {
  Process, Priority, % config.data.process, % level
}
genshin_64(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
