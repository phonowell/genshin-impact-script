...
global __ci_genshin__ := Func("genshin_148")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_146").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_145").Bind(this)
}
...
class ConsoleX {
  ...
  __New() {
    ...
    ticker.on.Call("change", Func("genshin_144").Bind(this))
    $.on.Call("alt + f9", Func("genshin_143").Bind(this))
  }
  clean := Func("genshin_142").Bind(this)
  hide := Func("genshin_141").Bind(this)
  log := Func("genshin_140").Bind(this)
  pickColor := Func("genshin_139").Bind(this)
  render := Func("genshin_138").Bind(this)
  update := Func("genshin_137").Bind(this)
}
...
class ClientX extends KeyBindingX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    ticker.on.Call("change", Func("genshin_136").Bind(this))
    this.on.Call("enter", Func("genshin_135").Bind(this))
    $.on.Call("alt + f4", Func("genshin_134").Bind(this))
    $.on.Call("ctrl + f5", Func("genshin_133").Bind(this))
    $.on.Call("alt + enter", Func("genshin_132").Bind(this))
  }
  check := Func("genshin_131").Bind(this)
  checkActive := Func("genshin_130").Bind(this)
  point := Func("genshin_129").Bind(this)
  reset := Func("genshin_128").Bind(this)
  resetTimer := Func("genshin_127").Bind(this)
  setSize := Func("genshin_126").Bind(this)
  suspend := Func("genshin_125").Bind(this)
  setPriority := Func("genshin_124").Bind(this)
  vh := Func("genshin_123").Bind(this)
  vw := Func("genshin_122").Bind(this)
}
...
class HudX {
  ...
  getPosition := Func("genshin_121").Bind(this)
  hide := Func("genshin_120").Bind(this)
  render := Func("genshin_119").Bind(this)
  reset := Func("genshin_117").Bind(this)
}
global hud := new HudX()
ts.checkIsActive := 0
...
class StatusCheckerX {
  ...
  isActive := false
  isSwimming := false
  checkIsActive := Func("genshin_116").Bind(this)
  checkIsSwimming := Func("genshin_115").Bind(this)
  checkPoint := Func("genshin_114").Bind(this)
  setIsActive := Func("genshin_113").Bind(this)
}
...
class PlayerX extends KeyBindingX {
  ...
  stopMove := Func("genshin_74").Bind(this)
  toggleQ := Func("genshin_73").Bind(this)
  useE := Func("genshin_71").Bind(this)
  useQ := Func("genshin_69").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  checkDown := Func("genshin_62").Bind(this)
  checkUp := Func("genshin_61").Bind(this)
}
...
class TacticX {
  ...
  attack := Func("genshin_60").Bind(this)
  delay := Func("genshin_57").Bind(this)
  execute := Func("genshin_56").Bind(this)
  get := Func("genshin_34").Bind(this)
  jump := Func("genshin_33").Bind(this)
  ongoing := Func("genshin_32").Bind(this)
  onMoving := Func("genshin_31").Bind(this)
  reset := Func("genshin_30").Bind(this)
  sprint := Func("genshin_29").Bind(this)
  start := Func("genshin_28").Bind(this)
  stop := Func("genshin_27").Bind(this)
  toggle := Func("genshin_26").Bind(this)
  useE := Func("genshin_25").Bind(this)
  validate := Func("genshin_24").Bind(this)
  wait := Func("genshin_23").Bind(this)
}
global tactic := new TacticX()
ts.jump := 0
player.on.Call("jump:start", Func("genshin_22")).on.Call("unhold:start", Func("genshin_20"))
timer.pick := ""
...
genshin_22() {
  ...
  $.setTimeout.Call(Func("genshin_21"), 350)
}
genshin_23(this, time, callback) {
...
genshin_25(this, isHolding, callback) {
...
genshin_31(this, cbA, cbB, isNot := false) {
...
genshin_37(next, this) {
  $.press.Call("r")
  $.setTimeout.Call(Func("genshin_36").Bind(next, this), 50)
}
...
genshin_43(next, this) {
  this.useE.Call(false, Func("genshin_42").Bind(next, this))
}
...
genshin_48(next, listTactic, g, this) {
  this.onMoving.Call(next, Func("genshin_47").Bind(listTactic, g, this))
}
genshin_49(listTactic, g, this) {
  this.execute.Call(listTactic, g + 1, 0)
}
genshin_50(next, listTactic, g, this) {
  this.ongoing.Call(next, Func("genshin_49").Bind(listTactic, g, this))
}
genshin_51(listTactic, g, this) {
  this.execute.Call(listTactic, g + 1, 0)
}
genshin_52(next, listTactic, g, this) {
  this.onMoving.Call(next, Func("genshin_51").Bind(listTactic, g, this), "not")
}
genshin_53(listTactic, g, this) {
  this.execute.Call(listTactic, g + 1, 0)
}
genshin_54(next, listTactic, g, this) {
  this.ongoing.Call(next, Func("genshin_53").Bind(listTactic, g, this), "not")
}
genshin_55(listTactic, g, i, this) {
  this.execute.Call(listTactic, g, i + 1)
}
genshin_56(this, listTactic, g := 0, i := 0) {
  ...
  next := Func("genshin_55").Bind(listTactic, g, i, this)
  map := {}
  map["!@e"] := Func("genshin_54").Bind(next, listTactic, g, this)
  map["!@m"] := Func("genshin_52").Bind(next, listTactic, g, this)
  map["@e"] := Func("genshin_50").Bind(next, listTactic, g, this)
  map["@m"] := Func("genshin_48").Bind(next, listTactic, g, this)
  map.a := Func("genshin_46").Bind(next, this)
  map["A~"] := Func("genshin_45").Bind(next, this)
  map.e := Func("genshin_44").Bind(next, this)
  map.ee := Func("genshin_43").Bind(next, this)
  map["E~"] := Func("genshin_41").Bind(next, this)
  map.j := Func("genshin_40").Bind(next, this)
  map.s := Func("genshin_39").Bind(next, this)
  map.t := Func("genshin_38").Bind(next, this)
  map.tt := Func("genshin_37").Bind(next, this)
  callback := map[__ci_genshin__.Call(item)]
  if !(callback) {
    callback := Func("genshin_35").Bind(item, next, this)
  }
  callback.Call()
}
genshin_57(this, time, callback) {
...
genshin_59(callback, this) {
  ...
  if (player.isMoving && player.name == "klee") {
    this.delay.Call(200, Func("genshin_58").Bind(callback, this))
    return
  }
  this.delay.Call(100, callback)
}
genshin_60(this, isCharged, callback) {
  ...
  if (isCharged) {
    ...
    this.delay.Call(delay, Func("genshin_59").Bind(callback, this))
    return
  }
  $.click.Call("left")
  this.delay.Call(200, callback)
...
genshin_69(this) {
  ...
  $.setTimeout.Call(Func("genshin_68"), statusChecker.interval)
}
genshin_70() {
  $.press.Call("e:up")
  skillTimer.record.Call("end")
}
genshin_71(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_70"), 1000)
}
genshin_72() {
  statusChecker.setIsActive.Call(true)
}
genshin_73(this, key) {
  ...
  member.toggle.Call(key)
  skillTimer.listQ[__ci_genshin__.Call(player.current)] := $.now.Call()
  $.setTimeout.Call(Func("genshin_72"), statusChecker.interval)
}
genshin_74(this, key) {
...
genshin_76(this, key) {
  ...
  $.setTimeout.Call(Func("genshin_75").Bind(key), 30)
}
genshin_77(this) {
  $.click.Call("right")
  ts.sprint := $.now.Call()
...
genshin_113(this, isActive) {
  ts.checkIsActive := $.now.Call()
  this.isActive := isActive
}
genshin_114(this, start, end, color := 0xFFFFFF) {
...
genshin_115(this) {
  ...
  isSwimming := this.checkPoint.Call([95, 95], [99, 99], 0xFFE92C)
  if (isSwimming) {
...
genshin_119(this, n, msg) {
  $$.vt.Call("hud.render", n, "number")
  $$.vt.Call("hud.render", msg, "string")
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_118").Bind(n, this), this.lifetime)
...
genshin_144(this, tick) {
  if !($.mod.Call(tick, 500)) {
    this.update.Call()
  }
}
genshin_145(this, key, defaultValue := "") {
