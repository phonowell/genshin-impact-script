...
class SkillTimerX {
  ...
  record := Func("genshin_101").Bind(this)
  recordEnd := Func("genshin_100").Bind(this)
  recordStart := Func("genshin_99").Bind(this)
  render := Func("genshin_98").Bind(this)
  reset := Func("genshin_97").Bind(this)
}
global skillTimer := new SkillTimerX()
ticker.on.Call("change", Func("genshin_96"))
class RecorderX {
  current := 0
  file := ""
  isActive := false
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_95").Bind(this))
  }
  ignore := Func("genshin_94").Bind(this)
  log := Func("genshin_93").Bind(this)
  next := Func("genshin_92").Bind(this)
  record := Func("genshin_90").Bind(this)
  replay := Func("genshin_89").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  pick := Func("genshin_79").Bind(this)
...
player.on.Call("jump:start", player.jump).on.Call("jump:end", Func("genshin_62"))
if (Config.data.betterJump) {
  player.on.Call("unhold:end", Func("genshin_61"))
}
timer.pick := ""
global pick := Func("genshin_59")
...
global startSprint := Func("genshin_53")
global stopSprint := Func("genshin_52")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint)
if (Config.data.betterSprint) {
  player.on.Call("move:end", Func("genshin_51"))
}
...
genshin_12() {
  tactic.delay.Call(100, Func("genshin_11"))
}
genshin_13() {
...
genshin_55() {
  ...
  $.clearTimeout.Call(timer.sprint)
  timer.sprint := $.setTimeout.Call(Func("genshin_54"), 1300)
}
genshin_56() {
  if (player.name == "mona") {
    return true
...
genshin_59() {
  $.clearTimeout.Call(timer.pick)
  timer.pick := $.setTimeout.Call(Func("genshin_58"), 150)
}
genshin_60() {
  player.jump.Call()
}
genshin_61() {
  $.setTimeout.Call(Func("genshin_60"), 100)
}
genshin_62() {
  ts.jump := $.now.Call()
  if (Config.data.betterJump) {
...
genshin_64() {
  $.setTimeout.Call(Func("genshin_63"), 200)
}
genshin_65(this) {
  count := 0
  for __index_for__, key in ["w", "a", "s", "d"] {
...
genshin_78() {
  $.press.Call("f:down")
  $.setTimeout.Call(Func("genshin_77"), 50)
}
genshin_79(this) {
  $.press.Call("f:up")
  $.setTimeout.Call(Func("genshin_78"), 50)
  $.click.Call("wheel-down")
}
genshin_80(this) {
  $.press.Call("space")
...
genshin_89(this) {
  ...
  $.setTimeout.Call(Func("genshin_88").Bind(list, this), 500)
}
genshin_90(this, key) {
...
genshin_91(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_92(this, list) {
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_91").Bind(key, list, this), delay)
}
genshin_93(this, message) {
