...
class KeyBindingX extends EmitterX {
  ...
  bindEvent := Func("genshin_47").Bind(this)
  press := Func("genshin_44").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  startMove := Func("genshin_42").Bind(this)
  stopMove := Func("genshin_41").Bind(this)
  toggleQ := Func("genshin_40").Bind(this)
  useE := Func("genshin_39").Bind(this)
  useQ := Func("genshin_37").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_36").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_35").Bind(key, this))
    }
  }
  check := Func("genshin_34").Bind(this)
  checkMove := Func("genshin_33").Bind(this)
}
global movement := new MovementX()
player.on.Call("move:start", Func("genshin_32")).on.Call("move:end", Func("genshin_31"))
if (Config.data.betterElementalVision) {
  player.on.Call("find:end", Func("genshin_30"))
}
global jumpTwice := Func("genshin_28")
if (Config.data.betterJump) {
  player.on.Call("jump:end", jumpTwice).on.Call("unhold:end", Func("genshin_26"))
}
timer.pick := ""
...
genshin_28() {
  $.delay.Call(200, Func("genshin_27"))
}
genshin_29() {
  $.press.Call("m")
}
genshin_30() {
  $.delay.Call(200, Func("genshin_29"))
}
genshin_31() {
  if !(player.isMoving) {
    return
...
genshin_39(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.delay.Call(1000, Func("genshin_38"))
  return this
}
genshin_40(this, key) {
  $.press.Call("alt + " . (key) . "")
...
genshin_47(this, name, key, option := "") {
  if !(option) {
  ...
  $.on.Call("" . (key) . "", Func("genshin_46").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_45").Bind(key, name, this))
  return this
}
genshin_48(tick) {
  if (Mod(tick, 200)) {
