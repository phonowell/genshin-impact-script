...
global __ci_genshin__ := Func("genshin_147")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_145").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_144").Bind(this)
}
...
class ConsoleX {
  ...
  __New() {
    ...
    ticker.on.Call("change", Func("genshin_143").Bind(this))
    $.on.Call("alt + f9", Func("genshin_142").Bind(this))
  }
  clean := Func("genshin_141").Bind(this)
  hide := Func("genshin_140").Bind(this)
  log := Func("genshin_139").Bind(this)
  pickColor := Func("genshin_138").Bind(this)
  render := Func("genshin_137").Bind(this)
...
class ClientX extends KeyBindingX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    ticker.on.Call("change", Func("genshin_135").Bind(this))
    this.on.Call("enter", Func("genshin_134").Bind(this))
    $.on.Call("alt + f4", Func("genshin_133").Bind(this))
    $.on.Call("ctrl + f5", Func("genshin_132").Bind(this))
...
class HudX {
  ...
  getPosition := Func("genshin_120").Bind(this)
  hide := Func("genshin_119").Bind(this)
  render := Func("genshin_118").Bind(this)
  reset := Func("genshin_116").Bind(this)
}
global hud := new HudX()
ts.checkIsActive := 0
...
class StatusCheckerX {
  ...
  isActive := false
  isSwimming := false
  checkIsActive := Func("genshin_115").Bind(this)
  checkIsSwimming := Func("genshin_114").Bind(this)
  checkPoint := Func("genshin_113").Bind(this)
  setIsActive := Func("genshin_112").Bind(this)
}
...
class CharacterX {
  ...
  getValueIntoArray := Func("genshin_111").Bind(this)
  getTactic := Func("genshin_110").Bind(this)
}
...
class SkillTimerX {
  ...
  endTartaglia := Func("genshin_100").Bind(this)
...
class RecorderX {
  ...
  log := Func("genshin_90").Bind(this)
  next := Func("genshin_89").Bind(this)
  record := Func("genshin_87").Bind(this)
  replay := Func("genshin_86").Bind(this)
  save := Func("genshin_84").Bind(this)
  start := Func("genshin_83").Bind(this)
  stop := Func("genshin_82").Bind(this)
}
...
class KeyBindingX extends EmitterShellX {
  ...
  bindEvent := Func("genshin_81").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  sprint := Func("genshin_76").Bind(this)
  startMove := Func("genshin_75").Bind(this)
...
genshin_81(this, name, key, prevent := false) {
  ...
  $.on.Call(key, Func("genshin_80").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_79").Bind(key, name, this))
  return this
}
genshin_82(this) {
  if !(this.isActive) {
...
genshin_86(this) {
  ...
  $.setTimeout.Call(Func("genshin_85").Bind(list, this), 500)
}
genshin_87(this, key) {
...
genshin_88(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_89(this, list) {
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_88").Bind(key, list, this), delay)
}
genshin_90(this, message) {
...
genshin_112(this, isActive) {
  ts.checkIsActive := $.now.Call()
  this.isActive := isActive
}
genshin_113(this, start, end, color := 0xFFFFFF) {
...
genshin_118(this, n, msg) {
  $$.vt.Call("hud.render", n, "number")
  $$.vt.Call("hud.render", msg, "string")
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_117").Bind(n, this), this.lifetime)
...
genshin_143(this, tick) {
  if !($.mod.Call(tick, 500)) {
    this.update.Call()
  }
}
genshin_144(this, key, defaultValue := "") {
