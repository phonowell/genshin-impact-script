...
global __ci_genshin__ := Func("genshin_146")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_144").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_143").Bind(this)
}
...
class ConsoleX {
  ...
  __New() {
    ...
    ticker.on.Call("change", Func("genshin_142").Bind(this))
    $.on.Call("alt + f9", Func("genshin_141").Bind(this))
  }
  clean := Func("genshin_140").Bind(this)
  hide := Func("genshin_139").Bind(this)
  log := Func("genshin_138").Bind(this)
  pickColor := Func("genshin_137").Bind(this)
  render := Func("genshin_136").Bind(this)
  update := Func("genshin_135").Bind(this)
}
...
class ClientX extends KeyBindingX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    ticker.on.Call("change", Func("genshin_134").Bind(this))
    this.on.Call("enter", Func("genshin_133").Bind(this))
    $.on.Call("alt + f4", Func("genshin_132").Bind(this))
    $.on.Call("ctrl + f5", Func("genshin_131").Bind(this))
    $.on.Call("alt + enter", Func("genshin_130").Bind(this))
  }
...
class CharacterX {
  ...
  getValueIntoArray := Func("genshin_110").Bind(this)
  getTactic := Func("genshin_109").Bind(this)
}
...
class SkillTimerX {
  ...
  endTartaglia := Func("genshin_99").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  sprint := Func("genshin_75").Bind(this)
  startMove := Func("genshin_74").Bind(this)
  stopMove := Func("genshin_73").Bind(this)
  toggleQ := Func("genshin_72").Bind(this)
...
genshin_68(this) {
  ...
  $.setTimeout.Call(Func("genshin_67"), statusChecker.interval)
}
genshin_69() {
  $.press.Call("e:up")
  skillTimer.record.Call("end")
...
genshin_72(this, key) {
  ...
  member.toggle.Call(key)
  skillTimer.listQ[__ci_genshin__.Call(player.current)] := $.now.Call()
  $.setTimeout.Call(Func("genshin_71"), statusChecker.interval)
}
genshin_73(this, key) {
...
genshin_111(this, isActive) {
  ts.checkIsActive := $.now.Call()
  this.isActive := isActive
}
genshin_112(this, start, end, color := 0xFFFFFF) {
...
genshin_114(this) {
  ...
  isActive := this.checkPoint.Call([1, 16], [4, 22])
  if (isActive) {
    this.isActive := true
    return true
  }
  isActive := this.checkPoint.Call([95, 2], [98, 7])
  if (isActive) {
    this.isActive := true
    return true
  }
...
genshin_142(this, tick) {
  if !($.mod.Call(tick, 500)) {
    this.update.Call()
  }
}
genshin_143(this, key, defaultValue := "") {
