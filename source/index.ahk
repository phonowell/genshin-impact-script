...
global __ci_genshin__ := Func("genshin_127")
if (A_IsAdmin != true) {
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    ...
    this.on.Call("resume", Func("genshin_125").Bind(this))
    this.setSize.Call()
    $.on.Call("alt + f4", Func("genshin_124").Bind(this))
    $.on.Call("ctrl + f5", Func("genshin_123").Bind(this))
    $.on.Call("alt + enter", Func("genshin_122").Bind(this))
  }
  check := Func("genshin_121").Bind(this)
  point := Func("genshin_120").Bind(this)
  reset := Func("genshin_119").Bind(this)
  resetTimer := Func("genshin_118").Bind(this)
  setSize := Func("genshin_117").Bind(this)
  suspend := Func("genshin_116").Bind(this)
  setPriority := Func("genshin_115").Bind(this)
  tick := Func("genshin_114").Bind(this)
  vh := Func("genshin_113").Bind(this)
  vw := Func("genshin_112").Bind(this)
}
...
class HudX {
  ...
  getPosition := Func("genshin_111").Bind(this)
  hide := Func("genshin_110").Bind(this)
  render := Func("genshin_109").Bind(this)
  reset := Func("genshin_107").Bind(this)
}
global hud := new HudX()
ts.checkIsActive := 0
...
class StatusCheckerX {
  ...
  isActive := false
  isSwimming := false
  checkIsActive := Func("genshin_106").Bind(this)
  checkIsSwimming := Func("genshin_105").Bind(this)
  checkPoint := Func("genshin_104").Bind(this)
  setIsActive := Func("genshin_103").Bind(this)
}
...
class CharacterX {
  ...
  __New() {
    data := {}
    data := $.mixin.Call(data, __ag__)
    data := $.mixin.Call(data, __hn__)
    data := $.mixin.Call(data, __ot__)
    data := $.mixin.Call(data, __uz__)
  ...
  getValueIntoArray := Func("genshin_102").Bind(this)
  getTactic := Func("genshin_101").Bind(this)
}
...
class MemberX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.on.Call("change", Func("genshin_100").Bind(this))
    $.on.Call("f12", this.scan)
  }
  checkCharacterByPosition := Func("genshin_99").Bind(this)
  getIndexBy := Func("genshin_98").Bind(this)
  getRange := Func("genshin_97").Bind(this)
  has := Func("genshin_96").Bind(this)
  scan := Func("genshin_95").Bind(this)
  toggle := Func("genshin_94").Bind(this)
  toggleBy := Func("genshin_93").Bind(this)
}
...
class SkillTimerX {
  ...
  check := Func("genshin_92").Bind(this)
  endTartaglia := Func("genshin_91").Bind(this)
  hide := Func("genshin_90").Bind(this)
  record := Func("genshin_89").Bind(this)
  recordEnd := Func("genshin_88").Bind(this)
  recordStart := Func("genshin_87").Bind(this)
  render := Func("genshin_86").Bind(this)
  reset := Func("genshin_85").Bind(this)
}
global skillTimer := new SkillTimerX()
client.on.Call("tick", Func("genshin_84"))
...
genshin_103(this, isActive) {
  ts.checkIsActive := $.now.Call()
  this.isActive := isActive
}
genshin_104(this, start, end, color := 0xFFFFFF) {
...
genshin_109(this, n, msg) {
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_108").Bind(n, this), this.lifetime)
...
genshin_115(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_116(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
