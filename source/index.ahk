...
global __ci_genshin__ := Func("genshin_132")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_131").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_130").Bind(this)
}
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_129").Bind(this))
    this.on.Call("enter", Func("genshin_128").Bind(this))
  }
  check := Func("genshin_127").Bind(this)
  checkActive := Func("genshin_126").Bind(this)
  point := Func("genshin_125").Bind(this)
  reset := Func("genshin_124").Bind(this)
  resetTimer := Func("genshin_123").Bind(this)
  setSize := Func("genshin_122").Bind(this)
  suspend := Func("genshin_121").Bind(this)
  setPriority := Func("genshin_120").Bind(this)
  vh := Func("genshin_119").Bind(this)
  vw := Func("genshin_118").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_117"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_116"))
  }
  getColor := Func("genshin_115").Bind(this)
  getPosition := Func("genshin_114").Bind(this)
  hide := Func("genshin_113").Bind(this)
  render := Func("genshin_112").Bind(this)
  reset := Func("genshin_110").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_109")
class MenuX {
  isVisible := false
  __New() {
    ticker.on.Call("change", Func("genshin_108").Bind(this))
  }
  checkVisibility := Func("genshin_107").Bind(this)
}
...
class MemberX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.on.Call("change", Func("genshin_106").Bind(this))
    $.on.Call("f12", this.scan)
  }
  checkCharacterByPosition := Func("genshin_105").Bind(this)
  getIndexBy := Func("genshin_104").Bind(this)
  getRange := Func("genshin_103").Bind(this)
  has := Func("genshin_102").Bind(this)
  scan := Func("genshin_101").Bind(this)
  toggle := Func("genshin_100").Bind(this)
  toggleBy := Func("genshin_99").Bind(this)
}
...
class SkillTimerX {
  ...
  check := Func("genshin_98").Bind(this)
  hide := Func("genshin_97").Bind(this)
  record := Func("genshin_96").Bind(this)
  recordEnd := Func("genshin_95").Bind(this)
  recordStart := Func("genshin_94").Bind(this)
  render := Func("genshin_93").Bind(this)
  reset := Func("genshin_92").Bind(this)
}
global skillTimer := new SkillTimerX()
ticker.on.Call("change", Func("genshin_91"))
class RecorderX {
  current := 0
  file := ""
  isActive := false
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_90").Bind(this))
  }
  ignore := Func("genshin_89").Bind(this)
...
class KeyBindingX extends EmitterShellX {
  ...
  press := Func("genshin_77").Bind(this)
  resetKey := Func("genshin_76").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_75").Bind(this)
  pick := Func("genshin_74").Bind(this)
...
genshin_17(callback) {
  for n, name in member.map {
    ...
    if (backend > 0) {
      tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_16").Bind(backend)
      continue
    }
    tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_15").Bind(backend)
  }
}
genshin_18() {
  if !(tactic.isActive) {
...
genshin_56() {
  $.clearTimeout.Call(timer.pick)
  timer.pick := $.setTimeout.Call(Func("genshin_55"), 100)
}
genshin_57() {
  player.jump.Call()
}
...
genshin_112(this, n, msg) {
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_111").Bind(n, this), this.lifetime)
...
genshin_120(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_121(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_130(this, key, defaultValue := "") {
  __array__ := $.split.Call(key, "/")
