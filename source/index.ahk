...
global __ci_genshin__ := Func("genshin_64")
if (A_IsAdmin != true) {
...
class ClientX {
  ...
  close := Func("genshin_62").Bind(this)
  getSize := Func("genshin_61").Bind(this)
  isActive := Func("genshin_60").Bind(this)
  isInside := Func("genshin_59").Bind(this)
  reset := Func("genshin_58").Bind(this)
  resetKey := Func("genshin_57").Bind(this)
  resetTimer := Func("genshin_56").Bind(this)
  suspend := Func("genshin_55").Bind(this)
  setPriority := Func("genshin_54").Bind(this)
  watch := Func("genshin_53").Bind(this)
}
class ConfigX {
  data := {character: [""]}
  source := "config.ini"
  ...
  read := Func("genshin_52").Bind(this)
}
timer.countDown := ""
global countDown := Func("genshin_51")
class PaimonX {
  ...
  timer := {close: ""}
  ts := {check: 0}
  bindEvent := Func("genshin_50").Bind(this)
  checkVisibility := Func("genshin_47").Bind(this)
  close := Func("genshin_46").Bind(this)
...
genshin_46(this, callback) {
  ...
  $.press.Call("esc")
  clearTimeout.Call(this.timer.close)
  this.timer.close := setTimeout.Call(Func("genshin_45").Bind(callback), 800)
}
genshin_47(this, forced := false) {
...
genshin_49(this, key) {
  this.close.Call(Func("genshin_48").Bind(this, key))
}
genshin_50(this) {
  for __index_for__, key in this.key {
    $.on.Call(key, Func("genshin_49").Bind(this, key))
  }
}
genshin_51(time) {
  if !(config.data.easySkillTimer) {
...
genshin_52(this, key, defaultValue := 1) {
...
genshin_54(this, level) {
  Process, Priority, % this.name, % level
}
genshin_55(this, isSuspend) {
  if (isSuspend) {
...
genshin_57(this) {
  ...
  for __index_for__, key in ["alt", "ctrl", "e", "f", "space", "w", "x"] {
    if ($.getState.Call(key)) {
      $.press.Call("" . (key) . ":up")
    }
  }
