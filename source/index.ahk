...
global __ci_genshin__ := Func("genshin_135")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_133").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_132").Bind(this)
}
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_131").Bind(this))
    this.on.Call("enter", Func("genshin_130").Bind(this))
  }
  check := Func("genshin_129").Bind(this)
  checkActive := Func("genshin_128").Bind(this)
  point := Func("genshin_127").Bind(this)
  reset := Func("genshin_126").Bind(this)
  resetTimer := Func("genshin_125").Bind(this)
  setSize := Func("genshin_124").Bind(this)
  suspend := Func("genshin_123").Bind(this)
  setPriority := Func("genshin_122").Bind(this)
  vh := Func("genshin_121").Bind(this)
  vw := Func("genshin_120").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_119"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_118"))
  }
  getColor := Func("genshin_117").Bind(this)
  getPosition := Func("genshin_116").Bind(this)
  hide := Func("genshin_115").Bind(this)
  render := Func("genshin_114").Bind(this)
  reset := Func("genshin_112").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_111")
class MenuX {
  isVisible := false
  __New() {
    ticker.on.Call("change", Func("genshin_110").Bind(this))
  }
  checkVisibility := Func("genshin_109").Bind(this)
}
global menu := new MenuX()
global __character_a_m__ := {aether: {color: 0}, albedo: {color: 0}, amber: {backend: 1, cd: 15, color: 6048867, duration: 8}, ayaka: {color: 0}, barbara: {backend: 1, cd: 32, color: 14603198, duration: 15}, beidou: {cd: 7.5, color: 4993838, typeE: 1}, bennett: {backend: 1, cd: [4.5, 10], color: 16511951}, chongyun: {backend: 1, cd: 15, color: 13496287, duration: 10}, diluc: {color: 0}, diona: {backend: -1, cd: [6, 15], color: 16701134, duration: [4, 10]}, fischl: {backend: 1, cd: 25, color: 16769961, duration: 10, typeE: 1}, ganyu: {backend: 1, cd: 10, color: 12438725, duration: 6}, hu_tao: {cd: 16, color: 8084321, duration: 9}, jean: {backend: -0.5, cd: 6, color: 15126691, typeE: 1}, kaeya: {backend: 1, cd: 6, color: 3755620}, keqing: {cd: 7.5, color: 12497347, duration: 5, typeE: 1}, klee: {backend: 1, cd: 20, color: 12466702}, lisa: {backend: 1, cd: [1, 16], color: 11970203}, lumine: {color: 0}, mona: {backend: 1, cd: 12, color: 5918820, duration: 6}}
global __character_n_z__ := {ningguang: {backend: 1, cd: 12, color: 16711134, duration: 29}, noelle: {backend: 1, cd: 24, color: 14604498, duration: 12}, qiqi: {backend: 1, cd: 30, color: 14801886, duration: 15}, rezor: {backend: 1, cd: [6, 10], color: 13028038}, rosaria: {color: 0}, sucrose: {backend: 1, cd: 14.5, color: 13953484}, tartaglia: {cd: 6, color: 14716223}, venti: {backend: 1.5, cd: [6, 15], color: 6132094}, xiangling: {backend: 1, cd: 12, color: 2241403, duration: 7}, xiao: {cd: 10, color: 3754046}, xingqiu: {backend: 1, cd: 21, color: 4753554, duration: 15}, xinyan: {backend: 1, cd: 18, color: 5258048, duration: 12}, zhongli: {backend: -1.5, cd: [4, 12.5], color: 4928805, duration: 20.5}}
class CharacterX {
...
class MemberX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.on.Call("change", Func("genshin_108").Bind(this))
    $.on.Call("f12", this.scan)
  }
  checkCharacterByPosition := Func("genshin_107").Bind(this)
  getIndexBy := Func("genshin_106").Bind(this)
  getRange := Func("genshin_105").Bind(this)
  has := Func("genshin_104").Bind(this)
  scan := Func("genshin_103").Bind(this)
  toggle := Func("genshin_102").Bind(this)
  toggleBy := Func("genshin_101").Bind(this)
}
...
class SkillTimerX {
  ...
  check := Func("genshin_100").Bind(this)
  hide := Func("genshin_99").Bind(this)
  record := Func("genshin_98").Bind(this)
  recordEnd := Func("genshin_97").Bind(this)
  recordStart := Func("genshin_96").Bind(this)
  render := Func("genshin_95").Bind(this)
  reset := Func("genshin_94").Bind(this)
}
global skillTimer := new SkillTimerX()
ticker.on.Call("change", Func("genshin_93"))
class RecorderX {
  current := 0
  file := ""
  isActive := false
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_92").Bind(this))
  }
  ignore := Func("genshin_91").Bind(this)
...
class KeyBindingX extends EmitterShellX {
  ...
  press := Func("genshin_79").Bind(this)
  resetKey := Func("genshin_78").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_77").Bind(this)
  pick := Func("genshin_76").Bind(this)
  startMove := Func("genshin_73").Bind(this)
  stopMove := Func("genshin_72").Bind(this)
  toggleQ := Func("genshin_71").Bind(this)
  useE := Func("genshin_70").Bind(this)
  useQ := Func("genshin_68").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_67").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_66").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_65")).on.Call("move:end", Func("genshin_64"))
  }
  check := Func("genshin_63").Bind(this)
  checkMove := Func("genshin_62").Bind(this)
}
global movement := new MovementX()
ts.jump := 0
global jumpTwice := Func("genshin_61")
player.on.Call("jump:start", player.jump).on.Call("jump:end", Func("genshin_59"))
if (Config.data.betterJump) {
  player.on.Call("unhold:end", Func("genshin_58"))
}
timer.pick := ""
global pick := Func("genshin_56")
global stopPick := Func("genshin_54")
...
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_53")
global sprint := Func("genshin_52")
global startSprint := Func("genshin_50")
global stopSprint := Func("genshin_49")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint)
if (Config.data.betterSprint) {
  player.on.Call("move:end", Func("genshin_48"))
}
state.toggleDelay := 200
global getToggleDelay := Func("genshin_47")
global startToggle := Func("genshin_46")
global stopToggle := Func("genshin_44")
...
class TacticX {
  ...
  chargedAttack := Func("genshin_35").Bind(this)
  delay := Func("genshin_33").Bind(this)
  freeze := Func("genshin_32").Bind(this)
  jump := Func("genshin_30").Bind(this)
  normalAttack := Func("genshin_29").Bind(this)
  reset := Func("genshin_28").Bind(this)
  start := Func("genshin_27").Bind(this)
  stop := Func("genshin_26").Bind(this)
  toggle := Func("genshin_25").Bind(this)
  useBackend := Func("genshin_24").Bind(this)
  validate := Func("genshin_20").Bind(this)
  validateBackend := Func("genshin_19").Bind(this)
}
global tactic := new TacticX()
tactic.common := Func("genshin_18")
member.on.Call("change", Func("genshin_17").Bind(callback))
tactic.hu_tao := Func("genshin_14")
global taoChargedAttack := Func("genshin_13")
tactic.backend.keqing := Func("genshin_9")
tactic.klee := Func("genshin_7")
global kleeChargedAttack := Func("genshin_6")
tactic.zhongli := Func("genshin_3")
...
genshin_9(callback) {
  ...
  player.useE.Call()
  tactic.delay.Call(700, Func("genshin_8").Bind(callback))
}
genshin_10() {
  tactic.delay.Call(100, tactic.hu_tao)
}
genshin_11() {
  tactic.jump.Call(Func("genshin_10"))
}
genshin_12() {
  tactic.delay.Call(50, Func("genshin_11"))
}
genshin_13() {
  tactic.chargedAttack.Call(Func("genshin_12"))
}
genshin_14() {
  if !(tactic.isActive) {
    return
...
genshin_16(name, backend, callback) {
  $$.vt.Call("tactic.backend." . (name) . "", callback, "function")
  player.useE.Call()
...
genshin_17(callback) {
  for n, name in member.map {
    ...
    if (backend > 0) {
      tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_16").Bind(name, backend)
      continue
    }
...
genshin_22(callback, this) {
  callback.Call()
  this.freeze.Call(1000)
}
genshin_23(name, callback, this) {
  this.backend[__ci_genshin__.Call(name)].Call(Func("genshin_22").Bind(callback, this))
}
genshin_24(this, callback) {
  ...
  for __index_for__, n in [4, 3, 2, 1] {
    ...
    this.toggle.Call(n, Func("genshin_23").Bind(name, callback, this))
    return true
  }
  if (this.origin && this.origin != player.current) {
    this.freeze.Call(10000)
    this.toggle.Call(this.origin, Func("genshin_21").Bind(callback, this))
    return true
  }
  return false
}
genshin_25(this, n, callback) {
  ($$.vt.Call("tactic.toggle", n, "number")).Call(callback, "function")
  if !(this.isActive) {
    return
  }
  $.press.Call(n)
...
genshin_32(this, wait) {
  $$.vt.Call("tactic.freeze", wait, "number")
  this.isFrozen := true
  $.clearTimeout.Call(timer.tacticFreeze)
  timer.tacticFreeze := $.setTimeout.Call(Func("genshin_31").Bind(this), wait)
}
genshin_33(this, time, callback) {
  ($$.vt.Call("tactic.delay", time, "number")).Call(callback, "function")
  if !(this.isActive) {
    return
  }
...
genshin_35(this, callback) {
  ...
  $.click.Call("left:down")
  this.delay.Call(400, Func("genshin_34").Bind(callback))
}
genshin_36() {
...
genshin_37() {
  ...
  $.setTimeout.Call(Func("genshin_36"), 2500)
}
genshin_38() {
...
genshin_52() {
  ...
  $.clearTimeout.Call(timer.sprint)
  timer.sprint := $.setTimeout.Call(Func("genshin_51"), 1300)
}
genshin_53() {
...
genshin_56() {
  $.clearTimeout.Call(timer.pick)
  timer.pick := $.setTimeout.Call(Func("genshin_55"), 150)
}
genshin_57() {
  player.jump.Call()
}
genshin_58() {
  $.setTimeout.Call(Func("genshin_57"), 50)
}
genshin_59() {
  ts.jump := $.now.Call()
  if (Config.data.betterJump) {
...
genshin_61() {
  $.setTimeout.Call(Func("genshin_60"), 200)
}
genshin_62(this) {
  count := 0
  for __index_for__, key in ["w", "a", "s", "d"] {
...
genshin_63(this, key, action) {
  ($$.vt.Call("movement.check", key, "string")).Call(action, "string")
...
genshin_70(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_69"), 1000)
  return this
}
genshin_71(this, key) {
  $$.vt.Call("player.toggleQ", key, "string")
  $.press.Call("alt + " . (key) . "")
  member.toggle.Call(key)
  return this
}
...
genshin_76(this) {
  $.press.Call("f:up")
  $.setTimeout.Call(Func("genshin_75"), 50)
  $.click.Call("wheel-down")
}
genshin_77(this) {
  $.press.Call("space")
...
genshin_79(this, key) {
  $$.vt.Call("keyBinding.press", key, "string")
...
genshin_82(this, name, key, prevent := false) {
  ($$.vt.Call("keyBinding.bindEvent", name, "string")).Call(key, ["number", "string"])
  if (prevent) {
...
genshin_95(this, n, message) {
  ($$.vt.Call("skillTimer.render", n, "number")).Call(message, "string")
...
genshin_114(this, n, msg) {
  ($$.vt.Call("hud.render", n, "number")).Call(msg, "string")
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_113").Bind(n, this), this.lifetime)
...
genshin_127(this, input) {
  $$.vt.Call("client.point", input, ["array", "function"])
...
genshin_132(this, key, defaultValue := "") {
...
genshin_134(name, target, type) {
  _type := $.type.Call(target)
  switch $.type.Call(type) {
    case "array": {
      listType := type
    }
    case "string": {
    ...
    default: {
      throw Exception("$$.vt/" . (name) . ": invalid type '" . ($.type.Call(type)) . "', from '" . ($.toString.Call(target)) . "'")
    }
  }
  if !($.includes.Call(listType, _type)) {
    throw Exception("" . (name) . ": invalid type '" . (_type) . "', should be '" . ($.toString.Call(listType)) . "'")
  }
  return $$.vt.Bind(name)
}
genshin_135(input) {
