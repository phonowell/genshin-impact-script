...
global __ci_genshin__ := Func("genshin_82")
if (A_IsAdmin != true) {
...
class EmitterX {
  bus := []
  emit := Func("genshin_81").Bind(this)
  off := Func("genshin_80").Bind(this)
  on := Func("genshin_79").Bind(this)
}
class TickerX extends EmitterX {
  ...
  update := Func("genshin_78").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_77").Bind(this)
}
...
class ClientX extends EmitterX {
  ...
  check := Func("genshin_76").Bind(this)
  checkActive := Func("genshin_75").Bind(this)
  reset := Func("genshin_74").Bind(this)
  resetKey := Func("genshin_73").Bind(this)
  resetTimer := Func("genshin_72").Bind(this)
  setSize := Func("genshin_71").Bind(this)
  suspend := Func("genshin_70").Bind(this)
  setPriority := Func("genshin_69").Bind(this)
  vh := Func("genshin_68").Bind(this)
  vw := Func("genshin_67").Bind(this)
}
...
class ConsoleX {
  ...
  clean := Func("genshin_64").Bind(this)
  hide := Func("genshin_63").Bind(this)
  log := Func("genshin_62").Bind(this)
...
class HudX {
  lifetime := 5000
  listTimer := {}
  getColor := Func("genshin_59").Bind(this)
  getPosition := Func("genshin_58").Bind(this)
  hide := Func("genshin_57").Bind(this)
  render := Func("genshin_56").Bind(this)
  reset := Func("genshin_54").Bind(this)
}
global hud := new HudX()
...
class MemberX {
  ...
  map := {}
  name := ""
  checkCharacterByPosition := Func("genshin_53").Bind(this)
  getRange := Func("genshin_52").Bind(this)
  scan := Func("genshin_51").Bind(this)
  toggle := Func("genshin_50").Bind(this)
}
...
class SkillTimerX {
  ...
  record := Func("genshin_48").Bind(this)
  recordEnd := Func("genshin_47").Bind(this)
  recordStart := Func("genshin_46").Bind(this)
  reset := Func("genshin_45").Bind(this)
}
global skillTimer := new SkillTimerX()
if (config.data.easySkillTimer) {
  ticker.on.Call("change", Func("genshin_44"))
}
...
player.on.Call("move-start", Func("genshin_43")).on.Call("move-end", Func("genshin_42")).on.Call("sprint-start", Func("genshin_41")).on.Call("sprint-end", Func("genshin_40"))
class MovementX extends EmitterX {
  ...
  checkJump := Func("genshin_38").Bind(this)
  checkMove := Func("genshin_37").Bind(this)
  checkPick := Func("genshin_36").Bind(this)
  checkSprint := Func("genshin_35").Bind(this)
...
player.on.Call("sprint-start", startSprint)
player.on.Call("sprint-end", stopSprint)
...
if (config.data.betterJump) {
  ...
  $.on.Call("x", Func("genshin_21"))
}
timer.pick := ""
global pick := Func("genshin_20")
global stopPick := Func("genshin_18")
if (config.data.fastPickup) {
  player.on.Call("pick-start", pick)
  player.on.Call("pick-end", stopPick)
}
...
$.on.Call("alt + enter", Func("genshin_9"))
$.on.Call("alt + f4", Func("genshin_8"))
$.on.Call("alt + f11", Func("genshin_7"))
$.on.Call("ctrl + f5", Func("genshin_6"))
$.on.Call("f12", member.scan)
for __index_for__, key in [1, 2, 3, 4] {
  $.on.Call(key, Func("genshin_5").Bind(key))
  $.on.Call("" . (key) . ":up", Func("genshin_4").Bind(key))
  $.on.Call("alt + " . (key) . "", Func("genshin_3").Bind(key))
}
if (config.data.easySkillTimer) {
  $.on.Call("e", Func("genshin_2"))
  $.on.Call("e:up", Func("genshin_1"))
}
...
genshin_20() {
  clearTimeout.Call(timer.pick)
  timer.pick := $.delay.Call(100, Func("genshin_19"))
}
genshin_21() {
  $.press.Call("x")
  $.press.Call("space")
...
genshin_23() {
  $.delay.Call(200, Func("genshin_22"))
}
genshin_24() {
...
genshin_34(this) {
  for __index_for__, key in ["w", "a", "s", "d", "r-button", "space", "f"] {
...
genshin_56(this, n, msg) {
  clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := setTimeout.Call(Func("genshin_55").Bind(n, this), this.lifetime)
...
genshin_69(this, level) {
  Process, Priority, % config.data.process, % level
}
genshin_70(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_77(this, key, defaultValue := 1) {
