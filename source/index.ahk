...
global __ci_genshin__ := Func("genshin_114")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_113").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_112").Bind(this)
}
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_111"))
  }
  check := Func("genshin_110").Bind(this)
  checkActive := Func("genshin_109").Bind(this)
  point := Func("genshin_108").Bind(this)
  reset := Func("genshin_107").Bind(this)
  resetTimer := Func("genshin_106").Bind(this)
  setSize := Func("genshin_105").Bind(this)
  suspend := Func("genshin_104").Bind(this)
  setPriority := Func("genshin_103").Bind(this)
  vh := Func("genshin_102").Bind(this)
  vw := Func("genshin_101").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_100"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_99"))
  }
  getColor := Func("genshin_98").Bind(this)
...
class StatusCheckerX {
  ...
  checkIsActive := Func("genshin_90").Bind(this)
  reset := Func("genshin_89").Bind(this)
}
global statusChecker := new StatusCheckerX()
ticker.on.Call("change", Func("genshin_88"))
...
class MemberX {
  ...
  checkCharacterByPosition := Func("genshin_87").Bind(this)
  getRange := Func("genshin_86").Bind(this)
  scan := Func("genshin_85").Bind(this)
  toggle := Func("genshin_84").Bind(this)
}
...
class SkillTimerX {
  ...
  hide := Func("genshin_82").Bind(this)
  record := Func("genshin_81").Bind(this)
  recordEnd := Func("genshin_80").Bind(this)
  recordStart := Func("genshin_79").Bind(this)
...
genshin_12() {
  ...
  if (skillTimer.listCountDown[__ci_genshin__.Call(member.current)] - $.now.Call() < 7000) {
...
genshin_103(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_104(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_112(this, key, defaultValue := "") {
  __array__ := $.split.Call(key, "/")
