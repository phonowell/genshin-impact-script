...
global __ci_genshin__ := Func("genshin_128")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_127").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_126").Bind(this)
}
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_125").Bind(this))
    this.on.Call("enter", Func("genshin_124").Bind(this))
  }
  check := Func("genshin_123").Bind(this)
  checkActive := Func("genshin_122").Bind(this)
  point := Func("genshin_121").Bind(this)
  reset := Func("genshin_120").Bind(this)
  resetTimer := Func("genshin_119").Bind(this)
  setSize := Func("genshin_118").Bind(this)
  suspend := Func("genshin_117").Bind(this)
  setPriority := Func("genshin_116").Bind(this)
  vh := Func("genshin_115").Bind(this)
  vw := Func("genshin_114").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_113"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_112"))
  }
  getColor := Func("genshin_111").Bind(this)
  getPosition := Func("genshin_110").Bind(this)
  hide := Func("genshin_109").Bind(this)
  render := Func("genshin_108").Bind(this)
  reset := Func("genshin_106").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_105")
class MenuX {
  isVisible := false
  __New() {
    ticker.on.Call("change", Func("genshin_104").Bind(this))
  }
  checkVisibility := Func("genshin_103").Bind(this)
}
global menu := new MenuX()
global __character_a_m__ := {aether: {color: 0}, albedo: {color: 0}, amber: {backend: 1, cd: 15, color: 6048867, duration: 8}, ayaka: {color: 0}, barbara: {backend: 1, cd: 32, color: 14603198, duration: 15}, beidou: {cd: 7.5, color: 4993838, typeE: 1}, bennett: {backend: 1, cd: [4.5, 10], color: 16511951}, chongyun: {backend: 1, cd: 15, color: 13496287, duration: 10}, diluc: {color: 0}, diona: {backend: -1, cd: [6, 15], color: 16701134, duration: [4, 10]}, fischl: {backend: 1, cd: 25, color: 16769961, duration: 10, typeE: 1}, ganyu: {backend: 1, cd: 10, color: 12438725, duration: 6}, hu_tao: {cd: 16, color: 8084321, duration: 9}, jean: {cd: 6, color: 15126691, typeE: 1}, kaeya: {backend: 1, cd: 6, color: 3755620}, keqing: {cd: 7.5, color: 12497347, duration: 5, typeE: 1}, klee: {backend: 1, cd: 20, color: 12466702}, lisa: {backend: 1, cd: [1, 16], color: 11970203}, lumine: {color: 0}, mona: {backend: 1, cd: 12, color: 5918820, duration: 6}}
...
class MemberX {
  ...
  checkCharacterByPosition := Func("genshin_102").Bind(this)
  getIndexBy := Func("genshin_101").Bind(this)
  getRange := Func("genshin_100").Bind(this)
  has := Func("genshin_99").Bind(this)
  scan := Func("genshin_98").Bind(this)
  toggle := Func("genshin_97").Bind(this)
  toggleBy := Func("genshin_96").Bind(this)
}
...
class SkillTimerX {
  ...
  listFrozen := {}
  listRecord := {}
  check := Func("genshin_95").Bind(this)
  hide := Func("genshin_94").Bind(this)
  record := Func("genshin_93").Bind(this)
  recordEnd := Func("genshin_92").Bind(this)
  recordStart := Func("genshin_89").Bind(this)
  render := Func("genshin_88").Bind(this)
...
class RecorderX {
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_85").Bind(this))
  }
  ignore := Func("genshin_84").Bind(this)
  next := Func("genshin_83").Bind(this)
  record := Func("genshin_81").Bind(this)
  replay := Func("genshin_80").Bind(this)
  save := Func("genshin_78").Bind(this)
  start := Func("genshin_77").Bind(this)
  stop := Func("genshin_76").Bind(this)
}
...
class KeyBindingX extends EmitterShellX {
  ...
  bindEvent := Func("genshin_75").Bind(this)
  press := Func("genshin_72").Bind(this)
  resetKey := Func("genshin_71").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_70").Bind(this)
  pick := Func("genshin_69").Bind(this)
  startMove := Func("genshin_68").Bind(this)
  stopMove := Func("genshin_67").Bind(this)
  toggleQ := Func("genshin_66").Bind(this)
  useE := Func("genshin_65").Bind(this)
  useQ := Func("genshin_63").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_62").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_61").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_60")).on.Call("move:end", Func("genshin_59"))
  }
  check := Func("genshin_58").Bind(this)
  checkMove := Func("genshin_57").Bind(this)
}
global movement := new MovementX()
global jumpTwice := Func("genshin_56")
player.on.Call("jump:start", player.jump)
if (Config.data.betterJump) {
  player.on.Call("jump:end", jumpTwice).on.Call("unhold:end", Func("genshin_54"))
}
timer.pick := ""
global pick := Func("genshin_52")
global stopPick := Func("genshin_50")
...
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_49")
global sprint := Func("genshin_48")
global startSprint := Func("genshin_46")
global stopSprint := Func("genshin_45")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint)
if (Config.data.betterSprint) {
  player.on.Call("move:end", Func("genshin_44"))
}
state.toggleDelay := 200
global getToggleDelay := Func("genshin_43")
global startToggle := Func("genshin_42")
global stopToggle := Func("genshin_40")
player.on.Call("toggle:start", startToggle).on.Call("toggle:end", stopToggle)
for __index_for__, key in [1, 2, 3, 4] {
  $.on.Call("alt + " . (key) . "", Func("genshin_37").Bind(key))
}
player.on.Call("use-e:start", Func("genshin_36")).on.Call("use-e:end", Func("genshin_35"))
state.isViewing := false
timer.view := ""
global toggleView := Func("genshin_34")
global view := Func("genshin_33")
...
class TacticX {
  ...
  chargedAttack := Func("genshin_31").Bind(this)
  delay := Func("genshin_29").Bind(this)
  freeze := Func("genshin_28").Bind(this)
  jump := Func("genshin_26").Bind(this)
  normalAttack := Func("genshin_25").Bind(this)
  start := Func("genshin_24").Bind(this)
  stop := Func("genshin_23").Bind(this)
  toggle := Func("genshin_22").Bind(this)
  useBackendE := Func("genshin_21").Bind(this)
  validate := Func("genshin_17").Bind(this)
}
global tactic := new TacticX()
tactic.common := Func("genshin_16")
(Func("genshin_15").Bind(callback)).Call()
...
genshin_13(backend, callback) {
  player.useE.Call("holding")
  tactic.delay.Call(0 - backend * 1000, callback)
}
genshin_14(backend, callback) {
  player.useE.Call()
...
genshin_15(callback) {
  for name, char in Character.data {
    ...
    if (backend > 0) {
      tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_14").Bind(backend)
      continue
    }
    tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_13").Bind(backend)
  }
}
genshin_16() {
  if !(tactic.isActive) {
  ...
  if (tactic.useBackendE.Call(tactic.common)) {
    return
  }
  if !(skillTimer.listCountDown[__ci_genshin__.Call(player.current)]) {
    player.useE.Call()
...
genshin_18(callback, this) {
  callback.Call()
  this.freeze.Call(1000)
}
genshin_19(m, callback, this) {
  this.toggle.Call(m, Func("genshin_18").Bind(callback, this))
}
genshin_20(name, m, callback, this) {
  this.backend[__ci_genshin__.Call(name)].Call(Func("genshin_19").Bind(m, callback, this))
}
genshin_21(this, callback) {
  if (this.isFrozen) {
    return
  }
  ...
  for __index_for__, n in [4, 3, 2, 1] {
    ...
    this.freeze.Call(5000)
    this.toggle.Call(n, Func("genshin_20").Bind(name, m, callback, this))
    return true
  }
  return false
}
genshin_22(this, n, callback) {
  $.press.Call(n)
  member.toggle.Call(n)
  this.delay.Call(300, callback)
}
genshin_23(this) {
  if (this.isActive) {
    this.count := 0
...
genshin_25(this, callback) {
  $.click.Call("left")
  this.delay.Call(100, callback)
}
genshin_26(this, callback) {
  player.jump.Call()
  if !(player.isMoving) {
...
genshin_28(this, wait := 1000) {
  this.isFrozen := true
  $.clearTimeout.Call(this.timer)
  this.timer := $.setTimeout.Call(Func("genshin_27").Bind(this), wait)
}
genshin_29(this, time, callback) {
  if !(this.isActive) {
    return
  }
...
genshin_31(this, callback) {
  $.click.Call("left:down")
  this.delay.Call(400, Func("genshin_30").Bind(callback))
}
genshin_32() {
...
genshin_33() {
  ...
  $.setTimeout.Call(Func("genshin_32"), 2500)
}
genshin_34() {
...
genshin_40(key) {
  ...
  if (typeApr == 3) {
    $.setTimeout.Call(Func("genshin_39"), state.toggleDelay)
    return
  }
  if (typeApr == 4) {
  ...
  $.setTimeout.Call(Func("genshin_38"), state.toggleDelay)
}
genshin_41() {
  $.press.Call("e:down")
  skillTimer.record.Call("start")
...
genshin_48() {
  ...
  $.clearTimeout.Call(timer.sprint)
  timer.sprint := $.setTimeout.Call(Func("genshin_47"), 1300)
}
genshin_49() {
...
genshin_52() {
  $.clearTimeout.Call(timer.pick)
  timer.pick := $.setTimeout.Call(Func("genshin_51"), 100)
}
genshin_53() {
  player.jump.Call()
}
genshin_54() {
  $.setTimeout.Call(Func("genshin_53"), 50)
}
genshin_55() {
  if !(player.isMoving) {
    return
...
genshin_56() {
  $.setTimeout.Call(Func("genshin_55"), 200)
}
genshin_57(this) {
  count := 0
  for __index_for__, key in ["w", "a", "s", "d"] {
...
genshin_65(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_64"), 1000)
  return this
}
genshin_66(this, key) {
  $.press.Call("alt + " . (key) . "")
...
genshin_75(this, name, key, prevent := false) {
  if (prevent) {
    this.isPrevented[__ci_genshin__.Call(key)] := true
  }
  $.on.Call("" . (key) . "", Func("genshin_74").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_73").Bind(key, name, this))
  return this
}
genshin_76(this) {
  if !(this.isActive) {
...
genshin_80(this) {
  ...
  $.setTimeout.Call(Func("genshin_79").Bind(list, this), 500)
}
genshin_81(this, key) {
  if !(this.isActive) {
    return
...
genshin_82(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_83(this, list) {
  n := this.current
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_82").Bind(key, list, this), delay)
}
genshin_84(this, key) {
  if !(key) {
    this.listIgnore := []
...
genshin_90(current, this) {
  this.listFrozen[__ci_genshin__.Call(current)] := true
}
genshin_91(current, this) {
  this.listFrozen[__ci_genshin__.Call(current)] := true
}
genshin_92(this, now) {
  __object__ := player
  ...
  if (now - this.listRecord[__ci_genshin__.Call(current)] < 500) {
    ...
    $.setTimeout.Call(Func("genshin_91").Bind(current, this), 2000)
    return
  }
  if (typeE == 1) {
  ...
  this.listRecord[__ci_genshin__.Call(current)] := 0
  $.setTimeout.Call(Func("genshin_90").Bind(current, this), 2000)
}
genshin_93(this, step) {
  __object__ := player
  current := __object__["current"]
  name := __object__["name"]
  if !(name) {
  ...
  if (this.listFrozen[__ci_genshin__.Call(current)]) {
    return
  }
  now := $.now.Call()
  if (step == "end") {
...
genshin_95(this) {
  ...
  for __index_for__, n in [1, 2, 3, 4] {
    ...
    if (now >= this.listCountDown[__ci_genshin__.Call(n)]) {
      ...
      this.listFrozen[__ci_genshin__.Call(n)] := false
    }
...
genshin_108(this, n, msg) {
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_107").Bind(n, this), this.lifetime)
...
genshin_116(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_117(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_126(this, key, defaultValue := "") {
  __array__ := $.split.Call(key, "/")
