...
global __ci_genshin__ := Func("genshin_125")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_123").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_122").Bind(this)
}
...
class ClientX extends KeyBindingX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    this.on.Call("enter", Func("genshin_121").Bind(this))
    $.on.Call("alt + f4", Func("genshin_120").Bind(this)).on.Call("ctrl + f5", Func("genshin_119").Bind(this)).on.Call("alt + enter", Func("genshin_118").Bind(this))
  }
  check := Func("genshin_117").Bind(this)
  checkActive := Func("genshin_116").Bind(this)
  point := Func("genshin_115").Bind(this)
  reset := Func("genshin_114").Bind(this)
  resetTimer := Func("genshin_113").Bind(this)
  setSize := Func("genshin_112").Bind(this)
  suspend := Func("genshin_111").Bind(this)
  setPriority := Func("genshin_110").Bind(this)
  vh := Func("genshin_109").Bind(this)
  vw := Func("genshin_108").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_107"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_106"))
  }
  getColor := Func("genshin_105").Bind(this)
  getPosition := Func("genshin_104").Bind(this)
  hide := Func("genshin_103").Bind(this)
  render := Func("genshin_102").Bind(this)
  reset := Func("genshin_100").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_99")
class MenuX {
  isVisible := false
  tsCheck := 0
  checkVisibility := Func("genshin_98").Bind(this)
}
...
class CharacterX {
  ...
  __New() {
    for name, char in this.data {
      ...
      tactic := Config.read.Call("" . (name) . "/tactic", 0)
      if (tactic) {
        tactic := $.replace.Call(tactic, " ", "")
        listAll := []
        for __index_for__, group in $.split.Call(tactic, ";") {
          listGroup := []
...
class MemberX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.on.Call("change", Func("genshin_97").Bind(this))
    $.on.Call("f12", this.scan)
  }
  checkCharacterByPosition := Func("genshin_96").Bind(this)
  getIndexBy := Func("genshin_95").Bind(this)
  getRange := Func("genshin_94").Bind(this)
  has := Func("genshin_93").Bind(this)
  scan := Func("genshin_92").Bind(this)
  toggle := Func("genshin_91").Bind(this)
  toggleBy := Func("genshin_90").Bind(this)
}
...
class SkillTimerX {
  ...
  record := Func("genshin_87").Bind(this)
  recordEnd := Func("genshin_86").Bind(this)
  recordStart := Func("genshin_85").Bind(this)
  render := Func("genshin_84").Bind(this)
  reset := Func("genshin_83").Bind(this)
}
global skillTimer := new SkillTimerX()
ticker.on.Call("change", Func("genshin_82"))
class RecorderX {
  current := 0
  file := ""
  isActive := false
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_81").Bind(this))
  }
  ignore := Func("genshin_80").Bind(this)
  log := Func("genshin_79").Bind(this)
  next := Func("genshin_78").Bind(this)
  record := Func("genshin_76").Bind(this)
  replay := Func("genshin_75").Bind(this)
  save := Func("genshin_73").Bind(this)
  start := Func("genshin_72").Bind(this)
  stop := Func("genshin_71").Bind(this)
}
...
class KeyBindingX extends EmitterShellX {
  ...
  bindEvent := Func("genshin_70").Bind(this)
  resetKey := Func("genshin_67").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_66").Bind(this)
  sprint := Func("genshin_65").Bind(this)
  startMove := Func("genshin_64").Bind(this)
  stopMove := Func("genshin_63").Bind(this)
  toggleQ := Func("genshin_62").Bind(this)
  useE := Func("genshin_61").Bind(this)
  useQ := Func("genshin_59").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_58").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_57").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_56")).on.Call("move:end", Func("genshin_55"))
  }
  check := Func("genshin_54").Bind(this)
  checkMove := Func("genshin_53").Bind(this)
}
global movement := new MovementX()
ts.jump := 0
global jumpTwice := Func("genshin_52")
player.on.Call("jump:start", player.jump).on.Call("jump:end", Func("genshin_51")).on.Call("unhold:end", Func("genshin_50"))
timer.pick := ""
global pick := Func("genshin_48")
global skip := Func("genshin_47")
global startPick := Func("genshin_46")
global stopPick := Func("genshin_45")
player.on.Call("pick:start", startPick).on.Call("pick:end", stopPick)
state.isSprinting := false
state.isSprintSwimming := false
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_44")
global sprint := Func("genshin_43")
global startSprint := Func("genshin_42")
global stopSprint := Func("genshin_41")
global swim := Func("genshin_40")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint).on.Call("move:start", Func("genshin_39")).on.Call("move:end", Func("genshin_38"))
state.toggleDelay := 150
global getToggleDelay := Func("genshin_37")
global startToggle := Func("genshin_36")
global stopToggle := Func("genshin_34")
player.on.Call("toggle:start", startToggle).on.Call("toggle:end", stopToggle).on.Call("toggle-q:end", player.toggleQ)
player.on.Call("use-e:start", Func("genshin_31")).on.Call("use-e:end", Func("genshin_30")).on.Call("use-q:start", player.useQ)
for __index_for__, n in [1, 2, 3, 4] {
  $.on.Call("alt + " . (key) . "", Func("genshin_29"))
}
state.isViewing := false
timer.view := ""
global toggleView := Func("genshin_28")
global view := Func("genshin_27")
...
class TacticX {
  ...
  attack := Func("genshin_25").Bind(this)
  delay := Func("genshin_22").Bind(this)
  execute := Func("genshin_21").Bind(this)
  freeze := Func("genshin_18").Bind(this)
  get := Func("genshin_16").Bind(this)
  jump := Func("genshin_15").Bind(this)
  ongoing := Func("genshin_14").Bind(this)
  ...
  useBackend := Func("genshin_8").Bind(this)
...
genshin_7(name, callback, this) {
  this.backend[__ci_genshin__.Call(name)].Call(Func("genshin_6").Bind(callback, this))
}
...
genshin_14(this, cbA, cbB) {
  ...
  if (skillTimer.listDuration[__ci_genshin__.Call(player.current)]) {
    this.delay.Call(100, cbA)
  } else {
    this.delay.Call(100, cbB)
  }
}
...
genshin_18(this, wait) {
  $$.vt.Call("tactic.freeze", wait, "number")
  this.isFrozen := true
  $.clearTimeout.Call(timer.tacticFreeze)
  timer.tacticFreeze := $.setTimeout.Call(Func("genshin_17").Bind(this), wait)
}
genshin_19(listTactic, g, this) {
  this.execute.Call(listTactic, g + 1, 0)
}
genshin_20(listTactic, g, i, this) {
  this.execute.Call(listTactic, g, i + 1)
}
genshin_21(this, listTactic, g := 0, i := 0) {
  item := this.get.Call(listTactic, g, i)
  if !(item) {
    this.execute.Call(listTactic)
    return
  }
  next := Func("genshin_20").Bind(listTactic, g, i, this)
  switch item {
    case "@e": {
      this.ongoing.Call(next, Func("genshin_19").Bind(listTactic, g, this))
    }
    case "a": {
...
genshin_23(callback, this) {
  this.jump.Call(callback)
}
genshin_24(callback, this) {
  $.click.Call("left:up")
  if (player.isMoving && player.name == "klee") {
    this.delay.Call(200, Func("genshin_23").Bind(callback, this))
    return
  }
  this.delay.Call(100, callback)
}
genshin_25(this, isCharged, callback) {
  $$.vt.Call("tactic.attack", callback, "function")
  if (isCharged) {
    $.click.Call("left:down")
    this.delay.Call(300, Func("genshin_24").Bind(callback, this))
    return
  }
  $.click.Call("left")
  this.delay.Call(200, callback)
...
genshin_27() {
  ...
  $.setTimeout.Call(Func("genshin_26"), 2500)
}
genshin_28() {
...
genshin_34() {
  ...
  if (typeApr == 2) {
    $.setTimeout.Call(Func("genshin_33"), state.toggleDelay)
    return
  }
  $.setTimeout.Call(Func("genshin_32"), state.toggleDelay)
}
genshin_35() {
  $.press.Call("e:down")
  skillTimer.record.Call("start")
...
genshin_36(key) {
  ...
  $.setTimeout.Call(Func("genshin_35"), state.toggleDelay)
}
genshin_37() {
...
genshin_50() {
  $.press.Call("x:down")
  $.setTimeout.Call(Func("genshin_49"), 100)
}
genshin_51() {
  ts.jump := $.now.Call()
  if (Config.data.betterJump) {
...
genshin_61(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_60"), 1000)
  return this
}
genshin_62(this, key) {
...
genshin_70(this, name, key, prevent := false) {
  ...
  $.on.Call(key, Func("genshin_69").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_68").Bind(key, name, this))
  return this
}
genshin_71(this) {
  if !(this.isActive) {
...
genshin_75(this) {
  ...
  $.setTimeout.Call(Func("genshin_74").Bind(list, this), 500)
}
genshin_76(this, key) {
...
genshin_77(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_78(this, list) {
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_77").Bind(key, list, this), delay)
}
genshin_79(this, message) {
...
genshin_102(this, n, msg) {
  $$.vt.Call("hud.render", n, "number")
  $$.vt.Call("hud.render", msg, "string")
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_101").Bind(n, this), this.lifetime)
...
genshin_122(this, key, defaultValue := "") {
