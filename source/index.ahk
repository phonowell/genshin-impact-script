...
global __ci_genshin__ := Func("genshin_138")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_136").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_135").Bind(this)
}
...
class ClientX extends KeyBindingX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    this.on.Call("enter", Func("genshin_134").Bind(this))
    $.on.Call("alt + f4", Func("genshin_133").Bind(this)).on.Call("ctrl + f5", Func("genshin_132").Bind(this)).on.Call("alt + enter", Func("genshin_131").Bind(this))
  }
  check := Func("genshin_130").Bind(this)
  checkActive := Func("genshin_129").Bind(this)
  point := Func("genshin_128").Bind(this)
  reset := Func("genshin_127").Bind(this)
  resetTimer := Func("genshin_126").Bind(this)
  setSize := Func("genshin_125").Bind(this)
  suspend := Func("genshin_124").Bind(this)
  setPriority := Func("genshin_123").Bind(this)
  vh := Func("genshin_122").Bind(this)
  vw := Func("genshin_121").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_120"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_119"))
  }
  getColor := Func("genshin_118").Bind(this)
  getPosition := Func("genshin_117").Bind(this)
  hide := Func("genshin_116").Bind(this)
  render := Func("genshin_115").Bind(this)
  reset := Func("genshin_113").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_112")
class MenuX {
  isVisible := false
  __New() {
    ticker.on.Call("change", Func("genshin_111").Bind(this))
  }
  checkVisibility := Func("genshin_110").Bind(this)
}
global menu := new MenuX()
global __character_a_m__ := {aether: {color: 0}, albedo: {color: 0}, amber: {backend: 1, cd: 15, color: 6048867, duration: 8}, ayaka: {color: 0}, barbara: {backend: 1, cd: 32, color: 14603198, duration: 15}, beidou: {cd: 7.5, color: 4993838, typeE: 1}, bennett: {backend: 1, cd: [4.5, 10], color: 16511951}, chongyun: {backend: 1, cd: 15, color: 13496287, duration: 10}, diluc: {color: 0}, diona: {backend: -1, cd: [6, 15], color: 16701134, duration: [4, 10]}, eula: {color: 0}, fischl: {backend: 1, cd: 25, color: 16769961, duration: 10, typeE: 1}, ganyu: {backend: 1, cd: 10, color: 12438725, duration: 6}, hu_tao: {cd: 16, color: 8084321, duration: 9}, jean: {backend: 1, cd: 6, color: 15652544, typeE: 1}, kaeya: {backend: 1, cd: 6, color: 3755620}, keqing: {cd: 7.5, color: 12497347, duration: 5, typeE: 1}, klee: {backend: 1, cd: 20, color: 12466702}, lisa: {backend: 1, cd: [1, 16], color: 11970203}, lumine: {color: 0}, mona: {backend: 1, cd: 12, color: 5918820, duration: 6}}
global __character_n_z__ := {ningguang: {backend: 1, cd: 12, color: 16776696, duration: 29}, noelle: {backend: 1, cd: 24, color: 14604498, duration: 12}, qiqi: {backend: 1, cd: 30, color: 14801886, duration: 15}, rezor: {backend: 1, cd: [6, 10], color: 13028038}, rosaria: {color: 0}, sucrose: {backend: 1, cd: 14.5, color: 13953484}, tartaglia: {cd: 6, color: 12153658}, venti: {backend: 1.5, cd: [6, 15], color: 6132094}, xiangling: {backend: 1, cd: 12, color: 3688571, duration: 7}, xiao: {cd: 10, color: 3754046}, xingqiu: {backend: 1, cd: 21, color: 4753554, duration: 15}, xinyan: {backend: 1, cd: 18, color: 5258048, duration: 12}, Yanfei: {color: 0}, zhongli: {backend: -1.5, cd: [4, 12.5], color: 4928805, duration: 20.5}}
class CharacterX {
...
class MemberX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.on.Call("change", Func("genshin_109").Bind(this))
    $.on.Call("f12", this.scan)
  }
  checkCharacterByPosition := Func("genshin_108").Bind(this)
  getIndexBy := Func("genshin_107").Bind(this)
  getRange := Func("genshin_106").Bind(this)
  has := Func("genshin_105").Bind(this)
  scan := Func("genshin_104").Bind(this)
  toggle := Func("genshin_103").Bind(this)
  toggleBy := Func("genshin_102").Bind(this)
}
...
class SkillTimerX {
  ...
  check := Func("genshin_101").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  useE := Func("genshin_74").Bind(this)
  useQ := Func("genshin_72").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_71").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_70").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_69")).on.Call("move:end", Func("genshin_68"))
  }
  check := Func("genshin_67").Bind(this)
  checkMove := Func("genshin_66").Bind(this)
}
global movement := new MovementX()
ts.jump := 0
global jumpTwice := Func("genshin_65")
player.on.Call("jump:start", player.jump).on.Call("jump:end", Func("genshin_64")).on.Call("unhold:end", Func("genshin_63"))
timer.pick := ""
global pick := Func("genshin_61")
global skip := Func("genshin_60")
global startPick := Func("genshin_59")
global stopPick := Func("genshin_58")
player.on.Call("pick:start", startPick).on.Call("pick:end", stopPick)
state.isSprinting := false
state.isSprintSwimming := false
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_57")
global sprint := Func("genshin_56")
global startSprint := Func("genshin_55")
global stopSprint := Func("genshin_54")
global swim := Func("genshin_53")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint).on.Call("move:start", Func("genshin_52")).on.Call("move:end", Func("genshin_51"))
state.toggleDelay := 150
global getToggleDelay := Func("genshin_50")
global startToggle := Func("genshin_49")
global stopToggle := Func("genshin_47")
player.on.Call("toggle:start", startToggle).on.Call("toggle:end", stopToggle).on.Call("toggle-q:end", player.toggleQ)
player.on.Call("use-e:start", Func("genshin_44")).on.Call("use-e:end", Func("genshin_43")).on.Call("use-q:start", player.useQ)
for __index_for__, n in [1, 2, 3, 4] {
  $.on.Call("alt + " . (key) . "", Func("genshin_42"))
}
state.isViewing := false
timer.view := ""
global toggleView := Func("genshin_41")
global view := Func("genshin_40")
...
class TacticX {
  ...
  chargedAttack := Func("genshin_38").Bind(this)
  delay := Func("genshin_36").Bind(this)
  freeze := Func("genshin_35").Bind(this)
  jump := Func("genshin_33").Bind(this)
  normalAttack := Func("genshin_32").Bind(this)
  ...
  useBackend := Func("genshin_27").Bind(this)
  validate := Func("genshin_23").Bind(this)
  validateBackend := Func("genshin_22").Bind(this)
}
global tactic := new TacticX()
tactic.common := Func("genshin_21")
member.on.Call("change", Func("genshin_20").Bind(callback))
tactic.fischl := Func("genshin_17")
global fischlAim := Func("genshin_16")
...
genshin_3() {
  ...
  switch tactic.count {
    case 0: {
      tactic.normalAttack.Call(tactic.qiqi)
    }
    case 1: {
      tactic.chargedAttack.Call(tactic.qiqi)
    }
  }
  tactic.count++
}
...
genshin_12() {
  tactic.delay.Call(150, Func("genshin_11"))
}
genshin_13() {
...
genshin_15() {
  $.press.Call("r")
  tactic.delay.Call(100, tactic.fischl)
}
genshin_16() {
  $.press.Call("r")
  tactic.delay.Call(100, Func("genshin_15"))
}
genshin_17() {
  if !(tactic.isActive) {
    return
  ...
  if !(tactic.isFrozen) {
    if !(skillTimer.listCountDown[__ci_genshin__.Call(player.current)]) {
      ...
      tactic.freeze.Call(1000)
      tactic.count := 0
      tactic.delay.Call(400, tactic.fischl)
      return
    }
  }
  if (tactic.count > 4) {
  ...
  switch tactic.count {
    case 0, 1, 2, 3: {
      tactic.normalAttack.Call(tactic.fischl)
    }
    case 4: {
      fischlAim.Call()
    }
...
genshin_20(callback) {
  for n, name in member.map {
    ...
    if (backend > 0) {
      tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_19").Bind(name, backend)
      continue
    }
    tactic.backend[__ci_genshin__.Call(name)] := Func("genshin_18").Bind(name, backend)
  }
}
genshin_21() {
  if !(tactic.isActive) {
...
genshin_24(callback, this) {
  callback.Call()
  this.freeze.Call(1000)
  this.origin := 0
}
genshin_25(callback, this) {
  callback.Call()
  this.freeze.Call(1000)
}
genshin_26(name, callback, this) {
  this.backend[__ci_genshin__.Call(name)].Call(Func("genshin_25").Bind(callback, this))
}
genshin_27(this, callback) {
  ...
  for __index_for__, n in [4, 3, 2, 1] {
    ...
    this.toggle.Call(n, Func("genshin_26").Bind(name, callback, this))
    return true
  }
  if (this.origin && this.origin != player.current) {
    this.freeze.Call(10000)
    this.toggle.Call(this.origin, Func("genshin_24").Bind(callback, this))
    return true
  }
  return false
}
...
genshin_32(this, callback) {
  $$.vt.Call("tactic.normalAttack", callback, "function")
  $.click.Call("left")
  this.delay.Call(200, callback)
}
genshin_33(this, callback) {
...
genshin_35(this, wait) {
  $$.vt.Call("tactic.freeze", wait, "number")
  this.isFrozen := true
  $.clearTimeout.Call(timer.tacticFreeze)
  timer.tacticFreeze := $.setTimeout.Call(Func("genshin_34").Bind(this), wait)
}
genshin_36(this, time, callback) {
...
genshin_38(this, callback) {
  $$.vt.Call("tactic.chargedAttack", callback, "function")
  $.click.Call("left:down")
  this.delay.Call(400, Func("genshin_37").Bind(callback))
}
genshin_39() {
...
genshin_40() {
  ...
  $.setTimeout.Call(Func("genshin_39"), 2500)
}
genshin_41() {
...
genshin_47() {
  ...
  if (typeApr == 2) {
    $.setTimeout.Call(Func("genshin_46"), state.toggleDelay)
    return
  }
...
genshin_49(key) {
  ...
  $.setTimeout.Call(Func("genshin_48"), state.toggleDelay)
}
genshin_50() {
...
genshin_59() {
  ...
  $.clearInterval.Call(timer.pick)
  timer.pick := $.setInterval.Call(pick, 150)
}
genshin_60() {
  if !(menu.isVisible) {
    return false
...
genshin_63() {
  $.press.Call("x:down")
  $.setTimeout.Call(Func("genshin_62"), 100)
}
genshin_64() {
  ts.jump := $.now.Call()
  if (Config.data.betterJump) {
...
genshin_74(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_73"), 1000)
  return this
}
genshin_75(this, key) {
...
genshin_115(this, n, msg) {
  $$.vt.Call("hud.render", n, "number")
  $$.vt.Call("hud.render", msg, "string")
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_114").Bind(n, this), this.lifetime)
...
genshin_135(this, key, defaultValue := "") {
