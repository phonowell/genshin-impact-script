...
global __ci_genshin__ := Func("genshin_97")
if (A_IsAdmin != true) {
...
class EmitterX {
  bus := []
  emit := Func("genshin_96").Bind(this)
  off := Func("genshin_95").Bind(this)
  on := Func("genshin_94").Bind(this)
}
class TickerX extends EmitterX {
  ...
  update := Func("genshin_93").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_92").Bind(this)
}
...
class ClientX extends EmitterX {
  ...
  checkActive := Func("genshin_90").Bind(this)
  point := Func("genshin_89").Bind(this)
  reset := Func("genshin_88").Bind(this)
  resetTimer := Func("genshin_87").Bind(this)
  setSize := Func("genshin_86").Bind(this)
  suspend := Func("genshin_85").Bind(this)
  setPriority := Func("genshin_84").Bind(this)
  vh := Func("genshin_83").Bind(this)
  vw := Func("genshin_82").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_81"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
  ...
  getColor := Func("genshin_80").Bind(this)
  getPosition := Func("genshin_79").Bind(this)
  hide := Func("genshin_78").Bind(this)
...
class StatusCheckerX {
  ...
  checkIsActive := Func("genshin_73").Bind(this)
...
genshin_77(this, n, msg) {
  clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.delay.Call(this.lifetime, Func("genshin_76").Bind(n, this))
...
genshin_84(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_85(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_92(this, key, defaultValue := "") {
