...
global __ci_genshin__ := Func("genshin_104")
if (A_IsAdmin != true) {
...
class EmitterX {
  bus := []
  emit := Func("genshin_103").Bind(this)
  off := Func("genshin_102").Bind(this)
  on := Func("genshin_101").Bind(this)
}
class TickerX extends EmitterX {
  ...
  update := Func("genshin_100").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_99").Bind(this)
}
...
class ClientX extends EmitterX {
  ...
  checkActive := Func("genshin_97").Bind(this)
  point := Func("genshin_96").Bind(this)
  reset := Func("genshin_95").Bind(this)
  resetTimer := Func("genshin_94").Bind(this)
  setSize := Func("genshin_93").Bind(this)
  suspend := Func("genshin_92").Bind(this)
  setPriority := Func("genshin_91").Bind(this)
  vh := Func("genshin_90").Bind(this)
  vw := Func("genshin_89").Bind(this)
}
...
class HudX {
  ...
  getColor := Func("genshin_87").Bind(this)
  getPosition := Func("genshin_86").Bind(this)
  hide := Func("genshin_85").Bind(this)
  render := Func("genshin_84").Bind(this)
  reset := Func("genshin_82").Bind(this)
}
global hud := new HudX()
...
class MemberX {
  ...
  map := {}
  name := ""
  checkCharacterByPosition := Func("genshin_77").Bind(this)
  getRange := Func("genshin_76").Bind(this)
  scan := Func("genshin_75").Bind(this)
  toggle := Func("genshin_74").Bind(this)
}
...
class SkillTimerX {
  ...
  hide := Func("genshin_72").Bind(this)
  record := Func("genshin_71").Bind(this)
  recordEnd := Func("genshin_70").Bind(this)
  recordStart := Func("genshin_69").Bind(this)
  reset := Func("genshin_68").Bind(this)
}
global skillTimer := new SkillTimerX()
if (Config.data.easySkillTimer) {
  ticker.on.Call("change", Func("genshin_67"))
}
class RecorderX {
  isActive := false
  list := []
  ...
  __New() {
    ...
    $.on.Call("ctrl + r", Func("genshin_66").Bind(this))
  }
  ignore := Func("genshin_65").Bind(this)
  record := Func("genshin_64").Bind(this)
  save := Func("genshin_63").Bind(this)
  start := Func("genshin_62").Bind(this)
  stop := Func("genshin_61").Bind(this)
}
...
class KeyBindingX extends EmitterX {
  ...
  bindEvent := Func("genshin_60").Bind(this)
  press := Func("genshin_57").Bind(this)
...
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_55").Bind(this)
  pick := Func("genshin_54").Bind(this)
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    player.on.Call("move:start", Func("genshin_45")).on.Call("move:end", Func("genshin_44"))
  }
  check := Func("genshin_43").Bind(this)
  checkMove := Func("genshin_42").Bind(this)
  press := Func("genshin_41").Bind(this)
}
...
genshin_60(this, name, key, prevent := false) {
  if (prevent) {
    this.isPrevented[__ci_genshin__.Call(key)] := true
  }
  $.on.Call("" . (key) . "", Func("genshin_59").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_58").Bind(key, name, this))
  return this
}
genshin_61(this) {
  if !(this.isActive) {
...
genshin_84(this, n, msg) {
  clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.delay.Call(this.lifetime, Func("genshin_83").Bind(n, this))
...
genshin_91(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_92(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_99(this, key, defaultValue := "") {
