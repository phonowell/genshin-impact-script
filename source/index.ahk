...
global __ci_genshin__ := Func("genshin_113")
if (A_IsAdmin != true) {
...
class TickerX extends EmitterShellX {
  ...
  update := Func("genshin_112").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_111").Bind(this)
}
...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_110"))
  }
  check := Func("genshin_109").Bind(this)
  checkActive := Func("genshin_108").Bind(this)
  point := Func("genshin_107").Bind(this)
  reset := Func("genshin_106").Bind(this)
  resetTimer := Func("genshin_105").Bind(this)
  setSize := Func("genshin_104").Bind(this)
  suspend := Func("genshin_103").Bind(this)
  setPriority := Func("genshin_102").Bind(this)
  vh := Func("genshin_101").Bind(this)
  vw := Func("genshin_100").Bind(this)
}
global client := new ClientX()
ticker.on.Call("change", Func("genshin_99"))
class HudX {
  lifetime := 5000
  listTimer := {}
  __New() {
    client.on.Call("leave", this.hide)
    $.on.Call("alt + f9", Func("genshin_98"))
  }
  getColor := Func("genshin_97").Bind(this)
  getPosition := Func("genshin_96").Bind(this)
  hide := Func("genshin_95").Bind(this)
  render := Func("genshin_94").Bind(this)
  reset := Func("genshin_92").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_91")
class MenuX {
...
class MemberX {
  ...
  checkCharacterByPosition := Func("genshin_88").Bind(this)
  getRange := Func("genshin_87").Bind(this)
  scan := Func("genshin_86").Bind(this)
  toggle := Func("genshin_85").Bind(this)
}
...
class SkillTimerX {
  ...
  listDuration := {}
  listRecord := {}
  check := Func("genshin_84").Bind(this)
  hide := Func("genshin_83").Bind(this)
  record := Func("genshin_82").Bind(this)
  recordEnd := Func("genshin_81").Bind(this)
  recordStart := Func("genshin_80").Bind(this)
  render := Func("genshin_79").Bind(this)
...
class RecorderX {
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_76").Bind(this))
  }
  ignore := Func("genshin_75").Bind(this)
  next := Func("genshin_74").Bind(this)
  record := Func("genshin_72").Bind(this)
  replay := Func("genshin_71").Bind(this)
  save := Func("genshin_69").Bind(this)
  start := Func("genshin_68").Bind(this)
  stop := Func("genshin_67").Bind(this)
}
...
class KeyBindingX extends EmitterShellX {
  ...
  bindEvent := Func("genshin_66").Bind(this)
  press := Func("genshin_63").Bind(this)
  resetKey := Func("genshin_62").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_61").Bind(this)
  pick := Func("genshin_60").Bind(this)
  startMove := Func("genshin_59").Bind(this)
  stopMove := Func("genshin_58").Bind(this)
  toggleQ := Func("genshin_57").Bind(this)
  useE := Func("genshin_56").Bind(this)
  useQ := Func("genshin_54").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_53").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_52").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_51")).on.Call("move:end", Func("genshin_50"))
  }
  check := Func("genshin_49").Bind(this)
  checkMove := Func("genshin_48").Bind(this)
}
global movement := new MovementX()
if (Config.data.betterElementalVision) {
  player.on.Call("find:end", Func("genshin_47"))
}
...
genshin_47() {
  $.setTimeout.Call(Func("genshin_46"), 200)
}
genshin_48(this) {
  count := 0
  for __index_for__, key in ["w", "a", "s", "d"] {
...
genshin_56(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_55"), 1000)
  return this
}
genshin_57(this, key) {
  $.press.Call("alt + " . (key) . "")
...
genshin_66(this, name, key, prevent := false) {
  if (prevent) {
    this.isPrevented[__ci_genshin__.Call(key)] := true
  }
  $.on.Call("" . (key) . "", Func("genshin_65").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_64").Bind(key, name, this))
  return this
}
genshin_67(this) {
  if !(this.isActive) {
...
genshin_71(this) {
  ...
  $.setTimeout.Call(Func("genshin_70").Bind(list, this), 500)
}
genshin_72(this, key) {
  if !(this.isActive) {
    return
...
genshin_73(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_74(this, list) {
  n := this.current
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_73").Bind(key, list, this), delay)
}
genshin_75(this, key) {
  if !(key) {
    this.listIgnore := []
...
genshin_94(this, n, msg) {
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_93").Bind(n, this), this.lifetime)
...
genshin_102(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_103(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
...
genshin_111(this, key, defaultValue := "") {
  __array__ := $.split.Call(key, "/")
