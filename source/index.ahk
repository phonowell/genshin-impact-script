...
global __ci_genshin__ := Func("genshin_87")
if (A_IsAdmin != true) {
...
class EmitterX {
  bus := []
  emit := Func("genshin_86").Bind(this)
  off := Func("genshin_85").Bind(this)
  on := Func("genshin_84").Bind(this)
}
class TickerX extends EmitterX {
  ...
  update := Func("genshin_83").Bind(this)
}
...
class ConfigX {
  ...
  read := Func("genshin_82").Bind(this)
}
...
class ClientX extends EmitterX {
  ...
  checkActive := Func("genshin_80").Bind(this)
...
class MemberX {
  ...
  map := {}
  name := ""
  checkCharacterByPosition := Func("genshin_58").Bind(this)
  getRange := Func("genshin_57").Bind(this)
  scan := Func("genshin_56").Bind(this)
  toggle := Func("genshin_55").Bind(this)
}
...
genshin_47(this, isHolding := false) {
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.delay.Call(1000, Func("genshin_46"))
}
genshin_48(this, key) {
  $.press.Call("alt + " . (key) . "")
  member.toggle.Call(key)
...
genshin_59(this, key, defaultValue := "") {
...
genshin_82(this, key, defaultValue := 1) {
  __array__ := $.split.Call(key, "/")
  __section__ := __array__[1]
  __key__ := __array__[2]
  IniRead, __result__, % this.source, % __section__, % __key__, % defaultValue
