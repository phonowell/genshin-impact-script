...
global __ci_genshin__ := Func("genshin_67")
if (A_IsAdmin != true) {
...
class ClientX {
  ...
  getSize := Func("genshin_65").Bind(this)
  isActive := Func("genshin_64").Bind(this)
  reset := Func("genshin_63").Bind(this)
  resetKey := Func("genshin_62").Bind(this)
  resetTimer := Func("genshin_61").Bind(this)
  suspend := Func("genshin_60").Bind(this)
  setPriority := Func("genshin_59").Bind(this)
}
class ConfigX {
  data := {}
  source := "config.ini"
...
class ConsoleX {
  ...
  clean := Func("genshin_56").Bind(this)
  hide := Func("genshin_55").Bind(this)
  log := Func("genshin_54").Bind(this)
  render := Func("genshin_53").Bind(this)
}
class HudX {
  findCharacterByPosition := Func("genshin_52").Bind(this)
  getColor := Func("genshin_51").Bind(this)
  getPosition := Func("genshin_50").Bind(this)
  getRange := Func("genshin_49").Bind(this)
  hide := Func("genshin_48").Bind(this)
  render := Func("genshin_47").Bind(this)
...
genshin_58(this, key, defaultValue := 1) {
...
genshin_59(this, level) {
  Process, Priority, % config.data.process, % level
}
genshin_60(this, isSuspend) {
  if (isSuspend) {
