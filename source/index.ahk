...
class ClientX {
  ...
  getSize := Func("genshin_63").Bind(this)
  isActive := Func("genshin_62").Bind(this)
  reset := Func("genshin_61").Bind(this)
  resetKey := Func("genshin_60").Bind(this)
  resetTimer := Func("genshin_59").Bind(this)
  suspend := Func("genshin_58").Bind(this)
  setPriority := Func("genshin_57").Bind(this)
}
class ConfigX {
  data := {}
  source := "config.ini"
  ...
  read := Func("genshin_56").Bind(this)
}
class ConsoleX {
  lifetime := 5000
  list := []
  ...
  clean := Func("genshin_54").Bind(this)
  hide := Func("genshin_53").Bind(this)
  log := Func("genshin_52").Bind(this)
...
genshin_56(this, key, defaultValue := 1) {
...
genshin_57(this, level) {
  Process, Priority, % config.data.process, % level
}
genshin_58(this, isSuspend) {
  if (isSuspend) {
