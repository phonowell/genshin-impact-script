...
global __ci_genshin__ := Func("genshin_68")
if (A_IsAdmin != true) {
...
class ClientX {
  ...
  getSize := Func("genshin_66").Bind(this)
  isActive := Func("genshin_65").Bind(this)
  reset := Func("genshin_64").Bind(this)
  resetKey := Func("genshin_63").Bind(this)
  resetTimer := Func("genshin_62").Bind(this)
  suspend := Func("genshin_61").Bind(this)
  setPriority := Func("genshin_60").Bind(this)
}
class ConfigX {
  data := {}
  source := "config.ini"
...
genshin_60(this, level) {
  Process, Priority, % config.data.process, % level
}
genshin_61(this, isSuspend) {
  if (isSuspend) {
