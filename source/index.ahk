...
class MovementX extends EmitterX {
  ...
  preventDefault := Func("genshin_38").Bind(this)
  startMove := Func("genshin_36").Bind(this)
  stopMove := Func("genshin_35").Bind(this)
}
global movement := new MovementX()
ticker.on.Call("change", movement.check)
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_34")
global sprint := Func("genshin_33")
global startSprint := Func("genshin_31")
global stopSprint := Func("genshin_30")
$.on.Call("r-button", startSprint)
$.on.Call("r-button:up", stopSprint)
if (config.data.betterSprint) {
  $.on.Call("w:up", Func("genshin_29"))
}
state.isJumping := false
timer.jump := ""
global jump := Func("genshin_27")
global jumpTwice := Func("genshin_25")
if (config.data.betterJump) {
  $.on.Call("space", jump)
  $.on.Call("x", Func("genshin_22"))
}
...
genshin_24(callback) {
  ...
  timer.jump := $.delay.Call(100, Func("genshin_23").Bind(callback))
}
genshin_25(callback) {
  $.press.Call("space")
  clearTimeout.Call(timer.jump)
  timer.jump := $.delay.Call(200, Func("genshin_24").Bind(callback))
}
genshin_26() {
  state.isJumping := false
}
genshin_27() {
  ...
  jumpTwice.Call(Func("genshin_26"))
}
genshin_28() {
...
genshin_33() {
  ...
  clearTimeout.Call(timer.sprint)
  timer.sprint := $.delay.Call(1300, Func("genshin_32"))
}
genshin_34() {
