...
global __ci_genshin__ := Func("genshin_62")
if (A_IsAdmin != true) {
...
class ClientX {
  ...
  check := Func("genshin_61").Bind(this)
  close := Func("genshin_60").Bind(this)
...
genshin_29() {
  ...
  if !(!paimon.state.isVisible && tactic[__ci_genshin__.Call(config.data.character[__ci_genshin__.Call(state.character)])]) {
    $.click.Call("left:up")
    return
  }
...
genshin_30() {
  ...
  tactic[__ci_genshin__.Call(config.data.character[__ci_genshin__.Call(state.character)])].attack.Call()
}
genshin_31(callback) {
  if !(state.isAttacking) {
    return
...
genshin_44(this, n) {
  point := $.findColor.Call(this.color[__ci_genshin__.Call(n)], this.point.start, this.point.end)
...
genshin_47(this, forced := false) {
  ...
  if (!forced && $.now.Call() - this.ts.check <= 5000) {
    return
  }
  ...
  if (this.findColor.Call(3)) {
    this.state.isVisible := false
    return
  }
  for __index_for__, n in [1, 2] {
