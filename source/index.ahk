...
class ClientX extends EmitterShellX {
  ...
  __New() {
    base.__New()
    this.setSize.Call()
    $.on.Call("alt + enter", Func("genshin_102"))
  }
  check := Func("genshin_101").Bind(this)
  checkActive := Func("genshin_100").Bind(this)
  point := Func("genshin_99").Bind(this)
  reset := Func("genshin_98").Bind(this)
  resetTimer := Func("genshin_97").Bind(this)
  setSize := Func("genshin_96").Bind(this)
  suspend := Func("genshin_95").Bind(this)
  setPriority := Func("genshin_94").Bind(this)
  vh := Func("genshin_93").Bind(this)
  vw := Func("genshin_92").Bind(this)
}
...
class HudX {
  ...
  __New() {
    ...
    $.on.Call("alt + f9", Func("genshin_90"))
  }
  getColor := Func("genshin_89").Bind(this)
  getPosition := Func("genshin_88").Bind(this)
  hide := Func("genshin_87").Bind(this)
  render := Func("genshin_86").Bind(this)
  reset := Func("genshin_84").Bind(this)
}
global hud := new HudX()
$$.log := Func("genshin_83")
class StatusCheckerX {
  ...
  checkIsActive := Func("genshin_81").Bind(this)
  reset := Func("genshin_80").Bind(this)
}
global statusChecker := new StatusCheckerX()
ticker.on.Call("change", Func("genshin_79"))
...
class MemberX {
  ...
  checkCharacterByPosition := Func("genshin_78").Bind(this)
  getRange := Func("genshin_77").Bind(this)
  scan := Func("genshin_76").Bind(this)
  toggle := Func("genshin_75").Bind(this)
}
global member := new MemberX()
class SkillTimerX {
  listCountDown := {}
  listRecord := {}
  check := Func("genshin_74").Bind(this)
  hide := Func("genshin_73").Bind(this)
  record := Func("genshin_72").Bind(this)
  recordEnd := Func("genshin_71").Bind(this)
  recordStart := Func("genshin_70").Bind(this)
  reset := Func("genshin_69").Bind(this)
}
...
class RecorderX {
  ...
  __New() {
    ...
    $.on.Call("f10", Func("genshin_67").Bind(this))
  }
  ignore := Func("genshin_66").Bind(this)
  next := Func("genshin_65").Bind(this)
  record := Func("genshin_63").Bind(this)
  replay := Func("genshin_62").Bind(this)
  save := Func("genshin_60").Bind(this)
  start := Func("genshin_59").Bind(this)
  stop := Func("genshin_58").Bind(this)
}
...
class KeyBindingX extends EmitterShellX {
  ...
  bindEvent := Func("genshin_57").Bind(this)
  press := Func("genshin_54").Bind(this)
  resetKey := Func("genshin_53").Bind(this)
}
class PlayerX extends KeyBindingX {
  ...
  jump := Func("genshin_52").Bind(this)
  pick := Func("genshin_51").Bind(this)
  startMove := Func("genshin_50").Bind(this)
  stopMove := Func("genshin_49").Bind(this)
  toggleQ := Func("genshin_48").Bind(this)
  useE := Func("genshin_47").Bind(this)
  useQ := Func("genshin_45").Bind(this)
}
...
class MovementX extends KeyBindingX {
  ...
  __New() {
    ...
    for __index_for__, key in ["w", "a", "s", "d"] {
      $.on.Call(key, Func("genshin_44").Bind(key, this))
      $.on.Call("" . (key) . ":up", Func("genshin_43").Bind(key, this))
    }
    player.on.Call("move:start", Func("genshin_42")).on.Call("move:end", Func("genshin_41"))
  }
  check := Func("genshin_40").Bind(this)
  checkMove := Func("genshin_39").Bind(this)
}
global movement := new MovementX()
if (Config.data.betterElementalVision) {
  player.on.Call("find:end", Func("genshin_38"))
}
global jumpTwice := Func("genshin_36")
player.on.Call("jump:start", player.jump)
if (Config.data.betterJump) {
  player.on.Call("jump:end", jumpTwice).on.Call("unhold:end", Func("genshin_34"))
}
timer.pick := ""
global pick := Func("genshin_32")
global stopPick := Func("genshin_30")
...
timer.sprint := ""
ts.sprint := 0
global checkSwimming := Func("genshin_29")
global sprint := Func("genshin_28")
global startSprint := Func("genshin_26")
global stopSprint := Func("genshin_25")
player.on.Call("sprint:start", startSprint).on.Call("sprint:end", stopSprint)
if (Config.data.betterSprint) {
  player.on.Call("move:end", Func("genshin_24"))
}
state.toggleDelay := 200
global getToggleDelay := Func("genshin_23")
global startToggle := Func("genshin_22")
global stopToggle := Func("genshin_20")
player.on.Call("toggle:start", startToggle).on.Call("toggle:end", stopToggle)
for __index_for__, key in [1, 2, 3, 4] {
  $.on.Call("alt + " . (key) . "", Func("genshin_17").Bind(key))
}
if (Config.data.easySkillTimer) {
  player.on.Call("use-e:start", Func("genshin_16")).on.Call("use-e:end", Func("genshin_15"))
}
...
class TacticX {
  ...
  delay := Func("genshin_11").Bind(this)
  start := Func("genshin_10").Bind(this)
  stop := Func("genshin_9").Bind(this)
  validate := Func("genshin_8").Bind(this)
}
global tactic := new TacticX()
tactic.klee := Func("genshin_7")
global kleeAttackA := Func("genshin_6")
global kleeAttackB := Func("genshin_5")
...
genshin_5() {
  ...
  tactic.delay.Call(300, Func("genshin_4"))
}
genshin_6() {
  $.click.Call("left")
...
genshin_20(key) {
  ...
  if (typeApr == 3) {
    $.setTimeout.Call(Func("genshin_19"), state.toggleDelay)
    return
  }
  if (typeApr == 4) {
  ...
  $.setTimeout.Call(Func("genshin_18"), state.toggleDelay)
}
genshin_21() {
  $.press.Call("e:down")
  skillTimer.record.Call("start")
...
genshin_22(key) {
  ...
  $.setTimeout.Call(Func("genshin_21"), state.toggleDelay)
}
genshin_23() {
...
genshin_28() {
  ...
  $.clearTimeout.Call(timer.sprint)
  timer.sprint := $.setTimeout.Call(Func("genshin_27"), 1300)
}
genshin_29() {
...
genshin_32() {
  $.clearTimeout.Call(timer.pick)
  timer.pick := $.setTimeout.Call(Func("genshin_31"), 100)
}
genshin_33() {
  player.jump.Call()
}
genshin_34() {
  $.setTimeout.Call(Func("genshin_33"), 50)
}
genshin_35() {
  if !(player.isMoving) {
    return
...
genshin_36() {
  $.setTimeout.Call(Func("genshin_35"), 200)
}
genshin_37() {
  $.press.Call("m")
}
genshin_38() {
  $.setTimeout.Call(Func("genshin_37"), 200)
}
genshin_39(this) {
  count := 0
  for __index_for__, key in ["w", "a", "s", "d"] {
...
genshin_47(this, isHolding := false) {
  if !(isHolding) {
    $.press.Call("e")
    skillTimer.record.Call("start")
    skillTimer.record.Call("end")
  ...
  $.press.Call("e:down")
  skillTimer.record.Call("start")
  $.setTimeout.Call(Func("genshin_46"), 1000)
  return this
}
genshin_48(this, key) {
  $.press.Call("alt + " . (key) . "")
...
genshin_57(this, name, key, prevent := false) {
  if (prevent) {
    this.isPrevented[__ci_genshin__.Call(key)] := true
  }
  $.on.Call("" . (key) . "", Func("genshin_56").Bind(key, name, this))
  $.on.Call("" . (key) . ":up", Func("genshin_55").Bind(key, name, this))
  return this
}
genshin_58(this) {
  if !(this.isActive) {
...
genshin_62(this) {
  ...
  $.setTimeout.Call(Func("genshin_61").Bind(list, this), 500)
}
genshin_63(this, key) {
  if !(this.isActive) {
    return
...
genshin_64(key, list, this) {
  $.trigger.Call(key)
  this.current++
  this.next.Call(list)
}
genshin_65(this, list) {
  n := this.current
  ...
  delay := __array__[1]
  key := __array__[2]
  $.setTimeout.Call(Func("genshin_64").Bind(key, list, this), delay)
}
genshin_66(this, key) {
  if !(key) {
    this.listIgnore := []
...
genshin_86(this, n, msg) {
  $.clearTimeout.Call(this.listTimer[__ci_genshin__.Call(n)])
  this.listTimer[__ci_genshin__.Call(n)] := $.setTimeout.Call(Func("genshin_85").Bind(n, this), this.lifetime)
...
genshin_94(this, level) {
  Process, Priority, % Config.data.process, % level
}
genshin_95(this, isSuspend) {
  if (isSuspend) {
    if (this.isSuspend) {
      return
    }
